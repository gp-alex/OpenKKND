...
#endif
#define LOBYTE_HEXRAYS(x) (*((_BYTE*)&(x)))
#define HIBYTE_HEXRAYS(x) (*((_BYTE*)&(x)+1))

#define LOWORD_HEXRAYS(x)   (*((_WORD*)&(x)))
#define SLOWORD_HEXRAYS(x)   (*((__int16 *)&(x)))
#define HIWORD_HEXRAYS(x)   (*((_WORD*)&(x)+1))
