...
void UNIT_Handler_Infantry(Script *a1)
{
    ...
    if (!_47C6DC_dont_execute_unit_handlers)
    {
        ...
        v2 = v1->sprite;
        v3 = v2->x;
        if (v3 < 0 || v3 >= _4793F8_map_width << 13 || (v4 = v2->y, v4 < 0) || v4 >= _478AAC_map_height << 13)
        {
            v1->sprite->x = 25600;
            v1->sprite->y = 25600;
        ...
        if (v1->entity_id == -1)
            sub_40F380_incdec(0);
        v5 = v1->entity_E0_outpost_clanhall;
        if (v5)
        {
            v6 = v5->entity_id;
            if (v6)
            {
                if (v6 == v1->entity_E0_outpost_clanhall_entity_id)
                {
                    v7 = v1->entity_E0_outpost_clanhall;
...
void entity_init_infantry(Entity *a1)
{
    ...
    if (a1->sprite->cplc_ptr1)
    {
        ...
        else
        {
            v11 = v1->sprite;
            v1->field_DC = 1;
            v1->sprite_width = v11->x;
            v1->sprite_height = v11->y;
            v1->sprite_width_2 = v1->sprite_width;
            v1->sprite_height_2 = v1->sprite_height;
            v1->field_A4 = v10;
            v12 = v1->script;
            v1->sprite_width_shr13 = v11->x >> 13;
            v1->sprite_height_shr13 = v11->y >> 13;
            v12->event_handler = EventHandler_General_Scout;
    ...
    else if (entity_413860_boxd(a1))
    {
        ...
        v20 = v1->sprite_width;
        v21 = (v1->sprite_height_shr13 << 13) + v19;
        v22 = v1->script;
        v1->sprite_height = v21;
        v1->field_DC = 1;
        v1->sprite_width_2 = v20;
        ...
        v23 = v1->sprite;
        v24 = v1->sprite_height;
        v25 = v1->sprite_width;
        v1->mode_return = entity_mode_415540_infantry;
        v26 = _42D560_get_mobd_lookup_id_rotation(v25 - v23->x, v24 - v23->y);
        v27 = v1->stats;
        v1->mobd_lookup_idx = v26;
        v1->sprite->field_1C_speed = v27->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v26 + 1]] >> 6;
        v1->sprite->field_20_neg_speed = -(v1->stats->speed
...
bool entity_413120(Entity *a1, Entity *a2, int entity_id)
{
    ...
    v6 = v5->x;
    v7 = v5->y;
    if (a1->stats->field_30_hp_regen_condition)
    {
        v8 = (a1->sprite->y & 0xFFFFE000) - v7 + entity_40F100(a1, a1->field_A4);
        v9 = v8 == 0;
        v10 = v8 < 0;
        v11 = v4->stats;
        v12 = v11->field_30_hp_regen_condition;
        if (v10 || v9)
        {
            v15 = v12 ? entity_40F100(v4, v4->field_A4) : v11->field_4C != 128 ? 7424 : 4096;
            v14 = v7 - (v4->sprite->y & 0xFFFFE000) - v15;
        }
        else
        {
            v13 = v12 ? entity_40F100(v4, v4->field_A4) : v11->field_4C != 128 ? 7424 : 4096;
            v14 = v13 + (v4->sprite->y & 0xFFFFE000) - v7;
        }
        v16 = v4->stats;
        v17 = v16->field_30_hp_regen_condition ? entity_40F0A0(v4, v4->field_A4) : v16->field_4C != 128 ? 7424 : 4096;
        v18 = v17 + (v4->sprite->x & 0xFFFFE000) - v6;
        v19 = v4->stats;
        v20 = v19->field_30_hp_regen_condition;
        if (v18 <= 0)
        {
            v23 = v20 ? entity_40F0A0(v4, v4->field_A4) : v19->field_4C != 128 ? 7424 : 4096;
            v22 = v6 - (v4->sprite->x & 0xFFFFE000) - v23;
        }
        else
        {
            v21 = v20 ? entity_40F0A0(v4, v4->field_A4) : v19->field_4C != 128 ? 7424 : 4096;
    ...
    if (v29 != entity_mode_417F50 && v29 != entity_mode_418590 && v29 != entity_mode_415690)
    {
        ...
        {
            v31 = v3->sprite;
            v32 = v31->field_1C_speed;
            if (v32 || v31->field_20_neg_speed)
            {
                v33 = (signed __int16)_42D560_get_mobd_lookup_id_rotation(v32, v31->field_20_neg_speed);
...
void entity_4133D0(Entity *a1)
{
    ...
    v1 = a1;
    v2 = a1->entity_E0_outpost_clanhall;
    a1->entity_8 = 0;
    if (v2 && (v3 = v2->entity_id) != 0 && v3 == v1->entity_E0_outpost_clanhall_entity_id && !v2->destroyed
    ...
    else
    {
        ...
        case 10:
            ...
            if (v7->field_30_hp_regen_condition)
                v8 = entity_40F0A0(v1, v1->field_A4);
            else
                v8 = v7->field_4C != 128 ? 7424 : 4096;
            v9 = v8 + (v1->sprite->x & 0xFFFFE000);
            v10 = v1->stats;
            v1->sprite_width_2 = v9;
            if (v10->field_30_hp_regen_condition)
                v11 = entity_40F100(v1, v1->field_A4);
            else
                v11 = v10->field_4C != 128 ? 7424 : 4096;
            v12 = v1->sprite->y;
            v1->mode_return = entity_mode_415540_infantry;
            v13 = v11 + (v12 & 0xFFFFE000);
            v14 = v1->sprite_width_2;
            v1->sprite_height_2 = v13;
            v1->sprite_height = v13;
            v1->sprite_width = v14;
        ...
        case 4:
            ...
            break;
        case 8:
            v15 = v1->sprite_width_2;
            v16 = v1->sprite_height_2;
            v1->field_DC = 1;
            v1->sprite_width = v15;
            v1->sprite_height = v16;
            entity_mode_415AB0(v1);
            break;
        default:
            if (v6 < 12)
...
bool entity_4135E0(Entity *a1)
{
    ...
    v1 = a1;
    v2 = a1->entity_E0_outpost_clanhall;
    if (v2 && (v3 = v2->entity_id) != 0 && v3 == a1->entity_E0_outpost_clanhall_entity_id)
    {
        if ((a1->field_DC == 2 || a1->field_DC == 5 || a1->field_DC == 8)
            && entity_413120(a1, v2, a1->entity_E0_outpost_clanhall_entity_id)
            && sub_44CE40(v1->player_side, v1->entity_E0_outpost_clanhall))
        {
            v4 = v1->entity_E0_outpost_clanhall;
            v1->entity_118_entity_id = v1->entity_E0_outpost_clanhall_entity_id;
            v1->entity_8 = v4;
            entity_418290(v1);
            return 1;
        }
    LABEL_19:
        if (!v1->stats->attach)
        {
            ...
            if (v13 != UNIT_STATS_SURV_MOBILE_OUTPOST
                ...
                && (v13 != UNIT_STATS_SURV_SABOTEUR || v1->field_DC != 3)
                && (v13 != UNIT_STATS_MUTE_VANDAL || v1->field_DC != 3)
                && (v13 != UNIT_STATS_SURV_TECHNICIAN || v1->field_DC != 3)
                && (v13 != UNIT_STATS_MUTE_MEKANIK || v1->field_DC != 3))
            {
                v14 = v1->_E4_entity;
                if (v14)
                {
    ...
    else
    {
        ...
        case 8:
            v6 = a1->stats;
            a1->entity_E0_outpost_clanhall = 0;
            a1->field_DC = 0;
            if (v6->field_30_hp_regen_condition)
            ...
            v1->sprite_width = v1->sprite_width_2;
            v12 = v10 + v11;
            v1->mode_return = entity_mode_415540_infantry;
            v1->sprite_height_2 = v12;
            v1->sprite_height = v12;
            entity_mode_416A70_oiltanker(v1);
            result = 1;
            break;
        case 2:
...
bool entity_413860_boxd(Entity *a1)
{
    ...
    if (v13->field_30_hp_regen_condition)
        v14 = entity_40F0A0(v1, v1->field_A4);
    else
    ...
    v1->sprite_width_shr13 = v7;
    v1->sprite_height_shr13 = v2;
    if (v16->field_30_hp_regen_condition)
        v17 = entity_40F100(v1, v1->field_A4);
    else
        v17 = v16->field_4C != 128 ? 7424 : 4096;
    v18 = v1->stats;
    if (v18->field_30_hp_regen_condition)
        v19 = entity_40F0A0(v1, v1->field_A4);
    else
        v19 = v18->field_4C != 128 ? 7424 : 4096;
...
bool entity_413A90_boxd(Entity *a1)
{
    ...
    v10 = a1a->stats;
    a1a->sprite_width_shr13 = v2;
    a1a->sprite_height_shr13 = v3;
    if (v10->field_30_hp_regen_condition)
        v11 = entity_40F100(a1a, a1a->field_A4);
    else
        v11 = v10->field_4C != 128 ? 7424 : 4096;
    v12 = a1a->stats;
    if (v12->field_30_hp_regen_condition)
        v13 = entity_40F0A0(a1a, a1a->field_A4);
    else
...
int entity_413C10(Entity *a1)
{
    ...
    v10 = v4 >> 13;
    v5 = v3 >> 13;
    v11 = (signed __int16)_42D560_get_mobd_lookup_id_rotation(v1->sprite_width - v3, v1->sprite_height - v4);
    v6 = ((unsigned __int8)v1->mobd_lookup_idx + 16) & 0xE0;
    v7 = v6 >> 5;
...
bool entity_413D10_boxd(Entity *a1)
{
    ...
    case 0xA:
        v2 = a1->entity_E0_outpost_clanhall;
        v3 = v1->sprite_width_2;
        v4 = v1->sprite_height_2;
        v1->sprite_width = v3;
        v1->sprite_height = v4;
        if (!v2)
            goto LABEL_25;
        v5 = v2->entity_id;
        if (!v5 || v5 != v1->entity_E0_outpost_clanhall_entity_id || *((_DWORD *)v2->state + 2))
            goto LABEL_25;
        v6 = v1->sprite;
        if (v6->x - v3 <= 0)
            v7 = v3 - v6->x;
        ...
        return result;
    case 1:
        v11 = a1->sprite_width_2;
        v12 = a1->sprite_height_2;
        v13 = v1->sprite;
        v1->sprite_width = v11;
        v1->sprite_height = v12;
        if ((v11 ^ v13->x) & 0xFFFFE000 || (v12 ^ v13->y) & 0xFFFFE000)
            goto LABEL_35;
        if (v1->script->script_type != -905969648)
            goto LABEL_25;
        result = 1;
        v1->mode = v1->mode_arrive;
        return result;
    case 0xB:
        v14 = a1->sprite_width_2;
        v15 = a1->sprite_height_2;
        v16 = v1->sprite;
        v1->sprite_width = v14;
        v1->sprite_height = v15;
        if (v16->x - v14 <= 0)
            v17 = v14 - v16->x;
        else
            v17 = v16->x - v14;
    ...
    case 6:
        v20 = a1->sprite;
        v21 = a1->sprite_height_2;
        v22 = v20->y;
        v23 = v20->x;
        v24 = a1->sprite_width_2 >> 13;
        v25 = (v23 - 25600) >> 13;
        v1->sprite_width = v1->sprite_width_2;
        v26 = (v23 + 25600) >> 13;
        v27 = v21 >> 13;
        v1->sprite_height = v1->sprite_height_2;
        if (v24 <= v25 || v24 >= v26 || v27 <= (v22 - 25600) >> 13 || v27 >= (v22 + 25600) >> 13)
            goto LABEL_35;
        entity_4054D0_tanker_convoy(v1);
        return 1;
    case 9:
        v28 = a1->sprite_width_2;
        v29 = a1->sprite_height_2;
        v30 = v1->sprite;
        v1->sprite_width = v28;
        v1->sprite_height = v29;
    ...
    case 7:
        ...
        {
            v40 = v1->stats;
            if (v40->field_30_hp_regen_condition)
                v41 = entity_40F0A0(v1, v1->field_A4);
            else
                v41 = v40->field_4C != 128 ? 7424 : 4096;
            v42 = v41 + (v1->sprite->x & 0xFFFFE000);
            v43 = v1->stats;
            v1->sprite_width = v42;
            if (v43->field_30_hp_regen_condition)
                v44 = entity_40F100(v1, v1->field_A4);
            else
            ...
            result = 1;
            v1->sprite_height = v46;
            return result;
        }
        v33 = v1->sprite_width_2;
        v34 = v1->sprite_height_2;
        v35 = v1->sprite;
        v1->sprite_width = v33;
        v1->sprite_height = v34;
        if (v35->x - v33 <= 0)
            v36 = v33 - v35->x;
        else
            v36 = v35->x - v33;
        ...
        return result;
    case 3:
        v47 = a1->entity_E0_outpost_clanhall;
        if (!v47)
            goto LABEL_25;
        v48 = v47->entity_id;
        if (!v48 || v48 != a1->entity_E0_outpost_clanhall_entity_id)
            goto LABEL_25;
        v49 = 0;
    ...
    case 2:
    case 4:
        v68 = a1->entity_E0_outpost_clanhall;
        if (v68)
        {
            v69 = v68->entity_id;
            if (v69)
            {
                if (v69 == v1->entity_E0_outpost_clanhall_entity_id)
                    goto LABEL_100;
            }
        }
        goto LABEL_25;
    case 8:
        v70 = a1->entity_E0_outpost_clanhall;
        if (v70 && (v71 = v70->entity_id) != 0 && v71 == a1->entity_E0_outpost_clanhall_entity_id)
        {
            v72 = a1->sprite_width_2;
            v73 = a1->sprite;
            v74 = a1->sprite_width_2 >> 13;
            v75 = v73->x >> 13;
            if ((v1->sprite_width_2 >> 13) - v75 <= 0)
                v76 = v75 - v74;
            else
                v76 = (v1->sprite_width_2 >> 13) - v75;
            v77 = v73->y;
            v78 = v1->sprite_height_2;
            v79 = v77 >> 13;
            if ((v1->sprite_height_2 >> 13) - v79 <= 0)
                v80 = v79 - (v1->sprite_height_2 >> 13);
            else
                v80 = (v1->sprite_height_2 >> 13) - v79;
            if (v76 + v80 <= 5)
            {
                v81 = v1->entity_E0_outpost_clanhall;
                v1->sprite_width = v81->sprite->x;
                v1->sprite_height = v81->sprite->y;
            }
            else
            {
                v1->sprite_width = v72;
                v1->sprite_height = v78;
                v1->entity_E0_outpost_clanhall = 0;
                v1->field_DC = 1;
            }
        }
        ...
        {
            v82 = a1->sprite_width_2;
            v83 = v1->sprite_height_2;
            v1->field_DC = 1;
            v1->sprite_width = v82;
            v1->sprite_height = v83;
        }
        goto LABEL_35;
    case 5:
        v68 = a1->entity_E0_outpost_clanhall;
        if (v68)
        {
            ...
            if (v84)
            {
                if (v84 == v1->entity_E0_outpost_clanhall_entity_id)
                {
                LABEL_100:
                    v1->sprite_width = v68->sprite->x;
                    v1->sprite_height = v68->sprite->y;
                LABEL_35:
                    entity_414440_boxd(v1, &v1->sprite_width, &v1->sprite_height);
                    return 0;
                }
            }
        }
                    ...
                    if (v6 < _4793F8_map_width)
                    {
                        ...
                        do
                        {
                            if (*v9 && sub_44CE00(a1a->player_side, *v9))
                            {
                                ...
                                a1a->entity_E0_outpost_clanhall = v11;
                                v12 = v11->entity_id;
                                a1a->_134_param__unitstats_after_mobile_outpost_plant = 600;
                                a1a->entity_E0_outpost_clanhall_entity_id = v12;
                                a1a->_E4_entity = 0;
                                a1a->entity_8 = 0;
                                entity_mode_415AB0(a1a);
                                return 1;
                            }
                            ++v8;
                            ++v9;
...
void entity_414670(Entity *a1)
{
    ...
    v3 = a1->entity_8;
    if ((!v3 || v3->entity_id != a1->entity_118_entity_id) && !entity_413120(a1, a1->_E4_entity, a1->_E4_entity_id))
    {
        v4 = v1->stats;
        v1->_E4_entity = 0;
        v5 = v1->sprite;
                            ...
                            if (*v15)
                            {
                                if (sub_44CE00(a1a->player_side, *v15))
                                {
                                    ...
                                    if (v16->field_54 || v16->speed)
                                    {
                                        ...
                                        {
                                            a1a->_E4_entity = v20->_4_entities[v14];
                                            a1a->_E4_entity_id = v20->_4_entities[v14]->entity_id;
                                            return;
                                        }
                                    }
                                }
        ...
        if ((stru31 **)stru31_list_477300 != &stru31_list_477300)
        {
            ...
            v1->_E4_entity = v17->param__entity__int;
            v1->_E4_entity_id = v17->param__entity__int->entity_id;
        }
    }
}
// 478AAC: using guessed type int _478AAC_map_height;
...
bool entity_414870_boxd(Entity *a1)
{
    ...
    if (v9 <= v10)
    {
        ...
        if (!v11)
        {
            v1->sprite_width = v16->x;
            v17 = v16->y;
            result = 1;
            v1->sprite_height = v2 + v17;
            return result;
        }
        if (boxd_41C130(v6 + v16->x, v16->y, v16->x, v16->y, v1))
        {
            v18 = v1->sprite;
            v1->sprite_width = v6 + v18->x;
            v1->sprite_height = v18->y;
            return 1;
        }
    }
    else
    {
        ...
        if (!v11)
        {
            v1->sprite_width = v6 + v12->x;
            v1->sprite_height = v12->y;
            return 1;
        }
        if (boxd_41C130(v12->x, v2 + v12->y, v12->x, v12->y, v1))
        {
            v14 = v1->sprite;
            v1->sprite_width = v14->x;
            v15 = v14->y;
            result = 1;
            v1->sprite_height = v2 + v15;
            return result;
        }
    }
    return 0;
...
void entity_4149A0(Entity *a1)
{
            ...
            v7 > 0x10000))
    {
        ...
        a1->field_DC = 11;
        a1->sprite_width_2 = v3;
        a1->sprite_height_2 = v14;
        entity_mode_415AB0(a1);
    }
    else
    {
        v2->field_1C_speed = 0;
        a1->sprite->field_20_neg_speed = 0;
        v8 = a1->stats;
        a1->field_DC = 1;
        if (v8->field_30_hp_regen_condition)
            v9 = entity_40F0A0(a1, a1->field_A4);
        else
            v9 = v8->field_4C != 128 ? 7424 : 4096;
        v10 = v9 + (v1->sprite->x & 0xFFFFE000);
        v11 = v1->stats;
        v1->sprite_width_2 = v10;
        if (v11->field_30_hp_regen_condition)
            v12 = entity_40F100(v1, v1->field_A4);
        else
            v12 = v11->field_4C != 128 ? 7424 : 4096;
...
bool entity_414AD0(Entity *a1)
{
    ...
    if (a1->stats->field_4C != 128)
        return 0;
    v2 = a1->sprite;
    v3 = v1->mobd_lookup_idx >> 4;
    v4 = (v2->y + _465948_per_mobd_lookup_idx[((_BYTE)v3 - 4) & 0xF]) >> 13;
    v5 = (v2->x + _465948_per_mobd_lookup_idx[v3]) >> 13;
    v6 = &_478AA8_boxd_stru0_array[v5 + _4793F8_map_width * v4];
    v7 = boxd_40EA50(v1, v5, v4, v6);
    if (v7 < 0)
        return 0;
    if (v7 <= 1)
    {
    ...
    if (v7 != 3)
        return 0;
    v1->stru224._2C_map_x = v5;
    v8 = 0;
    v1->stru224._30_map_y = v4;
    v9 = v6->_4_entities;
    while (1)
    {
        if (*v9)
        {
            v10 = (*v9)->mobd_lookup_idx;
            v11 = v1->mobd_lookup_idx;
            v12 = v10 - v11 <= 0 ? v11 - v10 : v10 - v11;
            if (v12 > 48)
                break;
        }
        ++v8;
...
void entity_414C30_boxd(Entity *a1)
{
    ...
    if (v2 & 0x3F)
    {
        v1->sprite->field_1C_speed = v1->stats->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v2 + 1]] >> 6;
        v1->sprite->field_20_neg_speed = 0;
        if (entity_40DA90_boxd(v1) == 4)
        {
            v4 = v1->sprite;
            if (v4->field_1C_speed <= 0)
            {
            ...
            LABEL_13:
                v1->sprite_width = v6 + (v8 & 0xFFFFE000);
                v1->sprite_height = v7->y;
                v1->mode = entity_mode_416790;
                return;
            }
        }
        v1->sprite->field_1C_speed = 0;
        v1->sprite->field_20_neg_speed = -(v1->stats->speed * _4731C8_speeds[__47CFC4_mobd_lookup_speeds[v3 + 1]]) >> 6;
        if (entity_40DA90_boxd(v1) == 4)
        {
            v10 = v1->sprite;
            if (v10->field_20_neg_speed <= 0)
            {
                v14 = v10->x;
            ...
            LABEL_25:
                v1->mode = entity_mode_416790;
                v1->sprite_height = v12 + (v13 & 0xFFFFE000);
                return;
            }
        }
    }
...
void entity_414E80(Entity *a1)
{
    ...
    v2 = (signed __int16)_42D560_get_mobd_lookup_id_rotation(
        a1->sprite_width - a1->sprite->x,
        a1->sprite_height - a1->sprite->y);
    if (!(v2 & 0x3F))
    {
        entity_mode_417E60(v1);
        return;
...
LABEL_18:
    v5 = v1->stats;
    v6 = v1->mobd_lookup_idx;
    v1->mobd_lookup_idx = v3;
    if (v5->field_4C == 128)
    {
        v7 = v1->sprite;
        v8 = v3 >> 4;
    ...
    if (v11 == 2 || v11 == 3)
    {
        switch (v1->mobd_lookup_idx)
        {
        case 0:
            v1->sprite_width = v1->sprite->x;
            v20 = v1->stats;
            if (v20->field_30_hp_regen_condition)
                v21 = entity_40F100(v1, v1->field_A4);
            else
                v21 = v20->field_4C != 128 ? 7424 : 4096;
            v22 = v1->sprite->y;
            v1->mobd_lookup_idx = v6;
            v1->mode = entity_mode_4165C0;
            v1->sprite_height = v21 + ((v22 - 0x2000) & 0xFFFFE000);
            return;
        case 0x40:
        LABEL_39:
            v23 = v1->stats;
            if (v23->field_30_hp_regen_condition)
            {
                v24 = entity_40F0A0(v1, v1->field_A4);
                v25 = v1->sprite;
                v26 = v25->x + 0x2000;
            }
            else
        ...
        LABEL_42:
            v27 = v1->stats;
            v1->sprite_width = v1->sprite->x;
            if (v27->field_30_hp_regen_condition)
                v28 = entity_40F100(v1, v1->field_A4);
            else
                v28 = v27->field_4C != 128 ? 7424 : 4096;
            v29 = v1->sprite->y;
            v1->mobd_lookup_idx = v6;
            v1->mode = entity_mode_4165C0;
            v1->sprite_height = v28 + ((v29 + 0x2000) & 0xFFFFE000);
            return;
        case 0xC0:
        LABEL_46:
            v30 = v1->stats;
            if (v30->field_30_hp_regen_condition)
                v24 = entity_40F0A0(v1, v1->field_A4);
            else
            ...
            v26 = v25->x - 0x2000;
        LABEL_50:
            v1->sprite_width = v24 + (v26 & 0xFFFFE000);
            v1->sprite_height = v25->y;
            break;
        default:
            break;
        }
    ...
    else
    {
        ...
        case 0:
            ...
            v1->mobd_lookup_idx = v6;
            v1->mode = entity_mode_4165C0;
            v1->sprite_height = v18 + ((v19 - 0x2000) & 0xFFFFE000);
            return;
        case 0x40:
            goto LABEL_39;
        case 0x80:
...
bool entity_415400(Entity *a1)
{
    ...
    v1 = a1;
    v2 = a1->unit_id;
    if (v2 != UNIT_STATS_SURV_TANKER && v2 != UNIT_STATS_MUTE_TANKER || a1->field_DC != 7)
        return 0;
...
void entity_mode_415540_infantry(Entity *a1)
{
    ...
    v9 = v1->sprite_width;
    v1->sprite_height = v8;
    v7->field_1C_speed = v9 - v7->x;
    v1->sprite->field_20_neg_speed = v1->sprite_height - v1->sprite->y;
    if (entity_40DA90_boxd(v1) == 4)
    {
        v1->sprite->x += v1->sprite->field_1C_speed;
        v1->sprite->y += v1->sprite->field_20_neg_speed;
    }
    v1->sprite->field_1C_speed = 0;
    v1->sprite->field_20_neg_speed = 0;
    v10 = v1->sprite;
    v1->sprite_width_2 = v10->x;
    v11 = v1->mobd_lookup_idx;
    v1->sprite_height_2 = v10->y;
    sprite_4272E0_load_mobd_item(v10, v1->stats->mobd_lookup_offset, _47D3C4_entity_mobd_lookup_ids[v11 + 1]);
...
void entity_mode_415690(Entity *a1)
{
    ...
    {
        if (v1->stats->field_30_hp_regen_condition)
        {
    ...
    v6 = v1->script;
    v1->_134_param__unitstats_after_mobile_outpost_plant = 0;
    script_445370_yield(v6, 0x80000000, 6);
    ...
    else if (v1->script->script_type != 0xCA00000F || v1->field_DC != 7)
    {
        v8 = v1->_E8_entity;
        if (v8)
        {
...
void entity_mode_4157F0(Entity *a1)
{
    ...
    if (v3 >= 70)
    {
        v6 = __OFSUB__(v3, 100);
        v5 = v3 - 100 < 0;
        v7 = a1->mobd_lookup_idx;
        if (v5 ^ v6)
        {
            v8 = (unsigned __int8)(v7 + 32);
            a1->mobd_lookup_idx = v8;
            sprite_4273B0_load_mobd_item_sound(
                a1->sprite,
                a1->stats->mobd_lookup_offset,
                _47D3C4_entity_mobd_lookup_ids[v8 + 1]);
        }
        else
        {
            v9 = a1->stats;
            v10 = (unsigned __int8)(v7 - 32);
            a1->mobd_lookup_idx = v10;
            sprite_4273B0_load_mobd_item_sound(a1->sprite, v9->mobd_lookup_offset, _47D3C4_entity_mobd_lookup_ids[v10 + 1]);
        }
    }
    else
    {
        v4 = a1->stats->mobd_lookup_table_offset;
        if (v4 != -1)
        {
            sprite_4272E0_load_mobd_item(a1->sprite, v4, _47D3C4_entity_mobd_lookup_ids[a1->mobd_lookup_idx + 1]);
...
void entity_mode_415A60(Entity *a1)
{
    ...
    v1 = a1;
    v2 = a1->field_88;
    v3 = (char *)&a1->mobd_lookup_idx;
    if (a1->mobd_lookup_idx == v2)
    {
        a1->mode = a1->mode_turn_return;
    }
    else
    {
        _44CB60_advance_mobd_frame(&a1->mobd_lookup_idx, v2, a1->stats->turning_speed);
        sprite_4273B0_load_mobd_item_sound(
            v1->sprite,
            v1->stats->_38_mobd_lookup_table_offset,
            _47D3C4_entity_mobd_lookup_ids[*(_DWORD *)v3 + 1]);
    }
}
...
void entity_mode_415AB0(Entity *a1)
{
    ...
    v2 = a1->unit_id;
    if (v2 != 23 && v2 != 24
        || (v3 = a1->sprite, v3->x >> 13 == a1->sprite_width_shr13) && v3->y >> 13 == a1->sprite_height_shr13)
    {
        a1->sprite->field_1C_speed = 0;
        a1->sprite->field_20_neg_speed = 0;
        entity_40DF50_boxd(a1, 1);
        if (!entity_413D10_boxd(v1))
        {
            sprite_4272E0_load_mobd_item(
                v1->sprite,
                v1->stats->mobd_lookup_offset,
            ...
            v6 = entity_41B970_boxd(v1, v1->sprite_width, v1->sprite_height);
            v1->stru224.field_4C = v6;
            switch (v6)
            {
            case 2:
                if (!v1->stru224.field_44 && !v1->stru224.field_48)
                    goto LABEL_37;
                v7 = v1->stats;
                if (v7->field_30_hp_regen_condition)
                    v8 = entity_40F0A0(v1, v1->field_A4);
            ...
            case 5:
                if (v1->stru224.field_44 || v1->stru224.field_48)
                {
                    v17 = v1->stats;
                    if (v17->field_30_hp_regen_condition)
                        v18 = entity_40F0A0(v1, v1->field_A4);
                    else
                        v18 = v17->field_4C != 128 ? 7424 : 4096;
                    v19 = v18 + (v1->stru224.field_44 << 13);
                    v10 = v1->stats;
                    v1->sprite_width = v19;
                    if (v10->field_30_hp_regen_condition)
                        v11 = entity_40F100(v1, v1->field_A4);
                    ...
                    v11 = v10->field_4C != 128 ? 7424 : 4096;
                LABEL_36:
                    v1->sprite_height = v11 + (v1->stru224.field_48 << 13);
                LABEL_37:
                    entity_mode_4165C0(v1);
                }
                else
                {
                LABEL_29:
...
void entity_415D30(Entity *a1)
{
    ...
    if (v2 < 0)
    {
        ...
        {
            if (a1->stru224.field_44 || a1->stru224.field_48)
            {
                v16 = a1->stats;
                if (v16->field_30_hp_regen_condition)
                    v17 = entity_40F0A0(a1, a1->field_A4);
                else
                    v17 = v16->field_4C != 128 ? 7424 : 4096;
                v18 = v17 + (v1->stru224.field_44 << 13);
                v19 = v1->stats;
                v1->sprite_width = v18;
                if (v19->field_30_hp_regen_condition)
                    v20 = entity_40F100(v1, v1->field_A4);
                else
                    v20 = v19->field_4C != 128 ? 7424 : 4096;
                v1->sprite_height = v20 + (v1->stru224.field_48 << 13);
                entity_mode_4165C0(v1);
            }
            else
            {
                entity_mode_417E60(a1);
            }
        }
        else
        {
    ...
    else
    {
        ...
        if (boxd_40EA50(
            ...
            && ((v4 = v1->stats, !v4->field_30_hp_regen_condition) ? (v5 = v4->field_4C != 128 ? 7424 : 4096) : (v5 = entity_40F100(v1, v1->field_A4)),
            (v6 = v1->stats, !v6->field_30_hp_regen_condition) ? (v7 = v6->field_4C != 128 ? 7424 : 4096) : (v7 = entity_40F0A0(v1, v1->field_A4)),
                boxd_41C130(
                    ...
                    v1)))
        {
            ...
            if (v11->field_30_hp_regen_condition)
                ...
                v12 = v11->field_4C != 128 ? 7424 : 4096;
            v1->sprite_height = v12 + (v1->stru224._30_map_y << 13);
            entity_mode_4165C0(v1);
        }
        else
        {
    ...
    while (1)
    {
        if (v1->field_124 & 8)
        {
            ...
            if (boxd_44D340(&v1->stru224._2C_map_x, &v1->stru224._30_map_y, 1, v1, &v1->stru224.field_3C))
            {
                ...
                LABEL_63:
                    ...
                    v1->mode_return = entity_mode_417E60;
                    entity_mode_416A70_oiltanker(v1);
                    return;
                }
                ...
                {
                    v7 = v1->stats;
                    v8 = v7->field_30_hp_regen_condition ? entity_40F100(v1, v1->field_A4) : v7->field_4C != 128 ? 7424 : 4096;
                    v9 = v1->stats;
                    v10 = v9->field_30_hp_regen_condition ? entity_40F0A0(v1, v1->field_A4) : v9->field_4C != 128 ? 7424 : 4096;
                    if (boxd_41C130(v10 + (*v4 << 13), v8 + (*v3 << 13), v1->sprite->x, v1->sprite->y, v1))
                    {
                        v32 = v1->stats;
                        if (v32->field_30_hp_regen_condition)
                            v33 = entity_40F0A0(v1, v1->field_A4);
                        else
                            v33 = v32->field_4C != 128 ? 7424 : 4096;
                        v34 = v33 + (v1->stru224._2C_map_x << 13);
                        v35 = v1->stats;
                        v1->sprite_width = v34;
                        if (v35->field_30_hp_regen_condition)
                        {
                            v36 = entity_40F100(v1, v1->field_A4);
        ...
        if (v1->field_124 & 0x10)
        {
            ...
            if (boxd_44D340(&v1->stru224._34_x, &v1->stru224._38_y, 0, v1, &v1->stru224._40_xy_idx))
            {
                ...
                {
                    v19 = v1->stats;
                    v20 = v19->field_30_hp_regen_condition ? entity_40F100(v1, v1->field_A4) : v19->field_4C != 128 ? 7424 : 4096;
                    v21 = v1->stats;
                    v22 = v21->field_30_hp_regen_condition ? entity_40F0A0(v1, v1->field_A4) : v21->field_4C != 128 ? 7424 : 4096;
                    if (boxd_41C130(v22 + (*v16 << 13), v20 + (*v15 << 13), v1->sprite->x, v1->sprite->y, v1))
                    {
                        v38 = v1->stats;
                        if (v38->field_30_hp_regen_condition)
                            v39 = entity_40F0A0(v1, v1->field_A4);
                        else
                            v39 = v38->field_4C != 128 ? 7424 : 4096;
                        v40 = v39 + (v1->stru224._34_x << 13);
                        v41 = v1->stats;
                        v1->sprite_width = v40;
                        if (v41->field_30_hp_regen_condition)
                            v36 = entity_40F100(v1, v1->field_A4);
                        else
                            v36 = v41->field_4C != 128 ? 7424 : 4096;
                        v37 = v1->stru224._38_y;
                    LABEL_71:
                        v1->sprite_height = v36 + (v37 << 13);
                        entity_mode_4165C0(v1);
                        return;
                    }
                }
...
void entity_mode_4165C0(Entity *a1)
{
    ...
    if (v4->field_30_hp_regen_condition)
    {
        v1->mobd_lookup_idx = (signed __int16)_42D560_get_mobd_lookup_id_rotation(
            v1->sprite_width - v2->x,
            v1->sprite_height - v2->y);
        entity_413C10(v1);
        sprite_4272E0_load_mobd_item(
            v1->sprite,
            v1->stats->_38_mobd_lookup_table_offset,
    ...
    else if (v4->field_4C == 128 || boxd_41C130(v1->sprite_width, v1->sprite_height, v2->x, v2->y, v1))
    {
        ...
        v7 = _42D560_get_mobd_lookup_id_rotation(v1->sprite_width - v5->x, v6 - v5->y);
        v8 = v1->mobd_lookup_idx;
        v9 = v1->stats;
        v1->mode_turn_return = entity_mode_416790;
        v1->field_88 = (v7 + 8) & 0xF0;
        sprite_4272E0_load_mobd_item(v1->sprite, v9->_38_mobd_lookup_table_offset, _47D3C4_entity_mobd_lookup_ids[v8 + 1]);
        v1->sprite->field_1C_speed = 0;
        v1->sprite->field_20_neg_speed = 0;
        v1->mode = entity_mode_415A60;
    }
...
void entity_mode_416790(Entity *a1)
{
    ...
    if (v10 < 768)
    {
        v11 = a1->sprite_height;
        v12 = v8->y - v11 <= 0 ? v11 - v8->y : v8->y - v11;
        if (v12 < 768)
            goto LABEL_52;
    }
    if (entity_4135E0(a1) || entity_415400(v1))
        return;
    v13 = v1->sprite;
    v14 = v1->field_B8;
    v15 = v13->x - v14 <= 0 ? v14 - v13->x : v13->x - v14;
    if (v15 > 0x10000
        || ((v16 = v1->field_BC, v13->y - v16 <= 0) ? (v17 = v16 - v13->y) : (v17 = v13->y - v16), v17 > 0x10000))
    {
    LABEL_52:
        entity_mode_415AB0(v1);
        return;
    ...
    if (v1->field_124 & 1
        || (!v1->stats->field_30_hp_regen_condition ? (v18 = entity_40D6F0(v1, v1->sprite_width, v1->sprite_height, 512)) : (v18 = entity_40D600(v1, v1->sprite_width, v1->sprite_height, 512)),
        (v19 = v18, v1->field_88 = v18, v18 == -1) || (v20 = v1->mobd_lookup_idx, v20 == v18)))
    {
    LABEL_37:
        v1->sprite->field_1C_speed = v1->stats->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]] >> 6;
        v1->sprite->field_20_neg_speed = -(v1->stats->speed
            * _4731C8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]]) >> 6;
        v1->sprite->field_1C_speed += v1->sprite->field_1C_speed < 0 ? 1 : 0;
        v1->sprite->field_20_neg_speed += v1->sprite->field_20_neg_speed < 0 ? 1 : 0;
        if (v1->stats->field_30_hp_regen_condition)
        {
            v23 = entity_40DA90_boxd(v1);
            if (v23 >= 0)
            {
                if (v23 <= 1)
                {
            ...
            LABEL_43:
                if (v23 == 3)
                {
                    v24 = v1->mobd_lookup_idx;
                    v25 = v1->stats;
                    v1->mode_return = entity_mode_4165C0;
                    sprite_4272E0_load_mobd_item(v1->sprite, v25->mobd_lookup_offset, _47D3C4_entity_mobd_lookup_ids[v24 + 1]);
                    v26 = v1->sprite;
                    v1->stru224._2C_map_x = v26->field_1C_speed;
                    v1->stru224._30_map_y = v26->field_20_neg_speed;
                    v26->field_1C_speed = 0;
                    v1->sprite->field_20_neg_speed = 0;
                    v27 = v1->field_124;
    ...
    {
        v1->mobd_lookup_idx = v19;
        sprite_4273B0_load_mobd_item_sound(
            v1->sprite,
            v22->_38_mobd_lookup_table_offset,
            _47D3C4_entity_mobd_lookup_ids[v19 + 1]);
        goto LABEL_37;
    }
    v28 = v1->sprite;
    v1->mode_turn_return = entity_mode_416790;
    sprite_4272E0_load_mobd_item(v28, v22->_38_mobd_lookup_table_offset, _47D3C4_entity_mobd_lookup_ids[v20 + 1]);
    v1->sprite->field_1C_speed = 0;
    v1->sprite->field_20_neg_speed = 0;
    v1->mode = entity_mode_415A60;
}
...
void entity_mode_416A70_oiltanker(Entity *a1)
{
    ...
    if (v3 != 4096)
    {
        ...
        v6 = v1->stats;
        v1->sprite_width = v5;
        v7 = v6->field_30_hp_regen_condition;
    LABEL_16:
        if (v7)
            v15 = entity_40F100(v1, v1->field_A4);
        else
            v15 = v6->field_4C != 128 ? 7424 : 4096;
        v16 = v1->sprite;
        v1->sprite_height = v15 + (v16->y & 0xFFFFE000);
        goto LABEL_24;
    }
    v8 = v2->field_30_hp_regen_condition;
    if ((v1->sprite->x & 0x1FFF) < 4096)
    {
        if (v8)
            v11 = entity_40F0A0(v1, v1->field_A4);
        else
            v11 = 7424;
        v10 = v1->sprite;
        v1->sprite_width = (v10->x & 0xFFFFE000) + v11 - 0x2000;
    }
    else
    {
        if (v8)
            ...
            v9 = 7424;
        v10 = v1->sprite;
        v1->sprite_width = v9 + (v10->x & 0xFFFFE000);
    }
    v6 = v1->stats;
    v12 = v10->y & 0x1FFF;
    ...
    v16 = v1->sprite;
    v1->sprite_height = (v16->y & 0xFFFFE000) + v17 - 0x2000;
LABEL_24:
    v18 = v16->x;
    v19 = v1->sprite_width;
    v20 = v16->x - v19;
    if (v20 <= 0)
        v20 = v19 - v18;
    if (v20 >= 512
        || ((v21 = v1->sprite_height, v16->y - v21 <= 0) ? (v22 = v21 - v16->y) : (v22 = v16->y - v21), v22 >= 512))
    {
        v23 = _42D560_get_mobd_lookup_id_rotation(v19 - v18, v1->sprite_height - v16->y);
        v24 = v1->stats;
        if (v24->field_30_hp_regen_condition || (v25 = v1->mobd_lookup_idx, v25 == v23))
        {
            v1->mobd_lookup_idx = v23;
            sprite_4272E0_load_mobd_item(
                v1->sprite,
                v24->_38_mobd_lookup_table_offset,
                _47D3C4_entity_mobd_lookup_ids[v23 + 1]);
        ...
        else
        {
            ...
            sprite_4272E0_load_mobd_item(
                v1->sprite,
                v24->_38_mobd_lookup_table_offset,
                _47D3C4_entity_mobd_lookup_ids[v25 + 1]);
            v1->sprite->field_1C_speed = 0;
            v1->sprite->field_20_neg_speed = 0;
            v1->mode = entity_mode_415A60;
        }
...
void entity_mode_416CD0(Entity *a1)
{
    ...
    if (v5 <= 0)
        v5 = v3 - v4;
    if (v5 >= 512 || ((v6 = v1->sprite_height, v2->y - v6 <= 0) ? (v7 = v6 - v2->y) : (v7 = v2->y - v6), v7 >= 512))
    {
        v8 = _42D560_get_mobd_lookup_id_rotation(v3 - v4, v1->sprite_height - v2->y);
        v9 = v1->sprite;
        v1->mobd_lookup_idx = v8;
        sprite_4273B0_load_mobd_item_sound(
            v9,
            v1->stats->_38_mobd_lookup_table_offset,
            _47D3C4_entity_mobd_lookup_ids[v8 + 1]);
        ...
        if (entity_40DA90_boxd(v1) != 4)
        {
            ...
            if (v11 != 4096)
            {
                ...
                v15 = v1->stats;
                if (v15->field_30_hp_regen_condition)
                    v16 = entity_40F100(v1, v1->field_A4);
                else
                    v16 = v15->field_4C != 128 ? 7424 : 4096;
...
LABEL_24:
    ...
    if (v20 <= 0)
        v20 = v19 - v18;
    if (v20 >= 1792
        || ((v21 = v1->sprite_height, v16->y - v21 <= 0) ? (v22 = v21 - v16->y) : (v22 = v16->y - v21), v22 >= 1792))
    {
        v23 = _42D560_get_mobd_lookup_id_rotation(v19 - v18, v1->sprite_height - v16->y);
        v24 = v1->stats;
        if (v24->field_30_hp_regen_condition || (v25 = v1->mobd_lookup_idx, v25 == v23))
...
void entity_mode_417100(Entity *a1)
{
    ...
    if (v5 <= 0)
        v5 = v3 - v4;
    if (v5 >= 1792 || ((v6 = v1->sprite_height, v2->y - v6 <= 0) ? (v7 = v6 - v2->y) : (v7 = v2->y - v6), v7 >= 1792))
    {
        v8 = _42D560_get_mobd_lookup_id_rotation(v3 - v4, v1->sprite_height - v2->y);
        v9 = v1->sprite;
        v1->mobd_lookup_idx = v8;
...
void entity_4172D0(Entity *a1)
{
    ...
    v2 = _42D560_get_mobd_lookup_id_rotation(a1->sprite_width - a1->sprite->x, a1->sprite_height - a1->sprite->y);
    v3 = v1->stats;
    v1->mobd_lookup_idx = v2;
    v1->sprite->field_1C_speed = v3->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v2 + 1]] >> 6;
...
void entity_mode_417360_infantry(Entity *a1)
{
    ...
    if (v5 >= 512 || ((v6 = v1->sprite_height, v2->y - v6 <= 0) ? (v7 = v6 - v2->y) : (v7 = v2->y - v6), v7 >= 512))
    {
        v16 = _42D560_get_mobd_lookup_id_rotation(v3 - v4, v1->sprite_height - v2->y);
        v17 = v1->stats;
        v1->mobd_lookup_idx = v16;
        sprite_4273B0_load_mobd_item_sound(
            v1->sprite,
            v17->_38_mobd_lookup_table_offset,
            _47D3C4_entity_mobd_lookup_ids[v16 + 1]);
        v1->sprite->field_1C_speed = v1->stats->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]] >> 6;
        v1->sprite->field_20_neg_speed = -(v1->stats->speed
            * _4731C8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]]) >> 6;
    }
            ...
            && v8 != UNIT_STATS_MUTE_MOBILE_DERRICK)
        {
            ...
            if (v9)
            {
                ...
                if (!v10)
                {
                    ...
                    v1->stru224.field_54 = 0;
                    v1->stru224.field_50 = 0;
                    script_445370_yield(v14, 0x80000000, 1);
                    v15 = v1->sprite_height_3;
                    v1->sprite_width_2 = v1->sprite_width_3;
                    v1->field_DC = 1;
                    v1->entity_E0_outpost_clanhall = 0;
                    v1->_134_param__unitstats_after_mobile_outpost_plant = 600;
                    v1->sprite_height_2 = v15;
                    v1->entity_8 = 0;
                    entity_40DF50_boxd(v1, 1);
                    v1->mode = entity_mode_415AB0;
                    return;
                }
                if (v10 == 1)
                {
                    ...
                    v1->stru224.field_54 = 0;
                    v1->stru224.field_50 = 0;
                    script_445370_yield(v11, 0x80000000, 1);
                    v12 = v1->_2A8_entity;
                    v13 = v1->_2A8_entity_id;
                    v1->field_DC = 2;
                    v1->entity_E0_outpost_clanhall = v12;
                    v1->entity_E0_outpost_clanhall_entity_id = v13;
                    v1->_E4_entity = 0;
                    v1->_134_param__unitstats_after_mobile_outpost_plant = 600;
                    v1->entity_8 = 0;
                    v1->mode = entity_mode_415AB0;
...
void entity_417550(Entity *a1)
{
    ...
    v1->sprite->field_20_neg_speed = 0;
    v2 = v1->sprite;
    v3 = v1->sprite_width >> 13;
    v4 = v1->sprite_height >> 13;
    v1->field_CC = v3;
    v1->field_D0 = v4;
    v5 = v2->x >> 13;
    v1->field_138 = v5;
...
void entity_417810(Entity *a1)
{
    ...
    if (v3 != v2->x >> 13 || v1->field_150 != v2->y >> 13)
    {
        ...
        if (v9->field_30_hp_regen_condition)
            ...
            v10 = v9->field_4C != 128 ? 7424 : 4096;
        v11 = v1->sprite;
        v1->sprite_height = v10 + (v1->field_D0 << 13);
        v12 = v1->mobd_lookup_idx;
        v1->stru224._2C_map_x = v11->_60_mobd_field_0_int;
        v13 = v1->field_124;
        v1->_128_spawn_param = 0;
        LOBYTE_HEXRAYS(v13) = v13 & 0xFE;
        v1->mode = entity_mode_417BD0;
        v1->field_124 = v13;
        sprite_4272E0_load_mobd_item(v11, v1->stats->_38_mobd_lookup_table_offset, _47D3C4_entity_mobd_lookup_ids[v12 + 1]);
        v1->sprite->field_1C_speed = 0;
        v1->sprite->field_20_neg_speed = 0;
        if (v1->field_D4)
        {
            v1->field_D8 = ((unsigned __int8)v1->mobd_lookup_idx + 64) & 0xE0;
...
void entity_417980(Entity *a1)
{
    ...
    v1 = a1;
    v2 = a1->sprite;
    v3 = v1->mobd_lookup_idx;
    v4 = v2->_60_mobd_field_0_int;
    v1->_128_spawn_param = 0;
    ...
    v1->mode = entity_mode_417BD0;
    v1->field_124 = v5;
    sprite_4272E0_load_mobd_item(v2, v1->stats->_38_mobd_lookup_table_offset, _47D3C4_entity_mobd_lookup_ids[v3 + 1]);
    v1->sprite->field_1C_speed = 0;
    v1->sprite->field_20_neg_speed = 0;
    if (v1->field_D4)
    {
            ...
            if (v4)
            {
                ...
                else
                {
                    ...
                    if (v5->field_30_hp_regen_condition)
                    {
                        ...
                        || boxd_41C130(v1->sprite_width, v1->sprite_height, v1->sprite->x, v1->sprite->y, v1))
                    {
                        v8 = _42D560_get_mobd_lookup_id_rotation(v1->sprite_width - v1->sprite->x, v1->sprite_height - v1->sprite->y);
                        v1->field_D8 = v8;
                        v9 = v1->stats;
                        v1->field_88 = ((_BYTE)v8 + 8) & 0xF0;
                        v10 = v1->mobd_lookup_idx;
                        v1->mode_turn_return = entity_mode_417BD0;
                        sprite_4272E0_load_mobd_item(
                            v1->sprite,
                            v9->_38_mobd_lookup_table_offset,
                            _47D3C4_entity_mobd_lookup_ids[v10 + 1]);
                        v1->sprite->field_1C_speed = 0;
                        v1->sprite->field_20_neg_speed = 0;
                        v1->mode = entity_mode_415A60;
                    }
...
void entity_mode_417BD0(Entity *a1)
{
    ...
    if (!entity_4135E0(a1))
    {
        if (!(v1->field_124 & 1))
        {
            v13 = v1->stats->field_30_hp_regen_condition ? entity_40D600(v1, v1->sprite_width, v1->sprite_height, 512) : entity_40D6F0(v1, v1->sprite_width, v1->sprite_height, 512);
            v14 = v13;
            v1->field_88 = v13;
            if (v13 != -1)
            {
                v15 = v1->mobd_lookup_idx;
                if (v15 != v13)
                {
                    v16 = v1->field_124;
                    ...
                    if (!v17->field_30_hp_regen_condition)
                    {
                        v23 = v1->sprite;
                        v1->mode_turn_return = entity_mode_417BD0;
                        sprite_4272E0_load_mobd_item(v23, v17->_38_mobd_lookup_table_offset, _47D3C4_entity_mobd_lookup_ids[v15 + 1]);
                        v1->sprite->field_1C_speed = 0;
                        v1->sprite->field_20_neg_speed = 0;
                        v1->mode = entity_mode_415A60;
                        return;
                    }
                    v1->mobd_lookup_idx = v14;
                    sprite_4273B0_load_mobd_item_sound(
                        v1->sprite,
                        v17->_38_mobd_lookup_table_offset,
                        _47D3C4_entity_mobd_lookup_ids[v14 + 1]);
                }
            }
        }
        v1->sprite->field_1C_speed = v1->stats->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]] >> 6;
        ...
        if (v1->stats->field_30_hp_regen_condition)
        {
            ...
            LABEL_35:
                if (v18 == 3)
                {
                    v19 = v1->mobd_lookup_idx;
                    v20 = v1->stats;
                    v1->mode_return = entity_mode_4165C0;
                    sprite_4272E0_load_mobd_item(v1->sprite, v20->mobd_lookup_offset, _47D3C4_entity_mobd_lookup_ids[v19 + 1]);
                    v21 = v1->sprite;
                    v1->stru224._2C_map_x = v21->field_1C_speed;
                    v1->stru224._30_map_y = v21->field_20_neg_speed;
                    v21->field_1C_speed = 0;
                    v1->sprite->field_20_neg_speed = 0;
                    v22 = v1->field_124;
...
void entity_mode_417E60(Entity *a1)
{
    ...
    if (!entity_4135E0(a1))
    {
        ...
        script_445370_yield(v1->script, 0x80000000, v6);
    }
}
...
void entity_417F60(Entity *a1)
{
    ...
    sprite_4272E0_load_mobd_item(
        ...
        _47D3C4_entity_mobd_lookup_ids[a1->mobd_lookup_idx + 1]);
    v2 = v1->sprite;
    v1->stru224._2C_map_x = v2->field_1C_speed;
    v1->stru224._30_map_y = v2->field_20_neg_speed;
    v2->field_1C_speed = 0;
    v1->sprite->field_20_neg_speed = 0;
    v3 = v1->field_124;
...
void entity_mode_417FC0(Entity *a1)
{
    ...
    v1 = a1;
    a1->sprite->field_1C_speed = a1->stru224._2C_map_x;
    a1->sprite->field_20_neg_speed = a1->stru224._30_map_y;
    v2 = entity_40DA90_boxd(a1) == 4;
    v1->sprite->field_1C_speed = 0;
    v1->sprite->field_20_neg_speed = 0;
    v3 = v1->sprite;
    if (v2)
    ...
    if (v6)
    {
        ...
        if (v7)
        {
            ...
            {
                v8 = v1->mobd_lookup_idx;
                if (v6->mobd_lookup_idx - v8 <= 0)
                    v9 = v8 - v6->mobd_lookup_idx;
                else
                    v9 = v6->mobd_lookup_idx - v8;
                if (v9 <= 48)
                {
    ...
    if (v1->field_124 & 0x40)
        entity_40DF50_boxd(v1, 0);
    script_445370_yield(v1->script, 0x80000000, 3);
}
...
void entity_418290(Entity *a1)
{
    ...
    if (!v1->stats->field_30_hp_regen_condition)
    {
        if (v1->mobd_lookup_idx != (signed __int16)_42D560_get_mobd_lookup_id_rotation(
            ...
            v1->entity_8->sprite->y - v1->sprite->y))
        {
            ...
            sprite_4272E0_load_mobd_item(v1->sprite, v4->_38_mobd_lookup_table_offset, _47D3C4_entity_mobd_lookup_ids[v3 + 1]);
            v1->sprite->field_1C_speed = 0;
            v1->sprite->field_20_neg_speed = 0;
            v1->mode = entity_mode_415A60;
            return;
    ...
    v5 = v1->sprite->x;
    v6 = (v5 & 0xFFFFE000) - v5 + entity_40F0A0(v1, v1->field_A4);
    v7 = v6 == 0;
    v8 = v6 < 0;
    v9 = v1->stats;
    v10 = v9->field_30_hp_regen_condition;
    if (v8 || v7)
    {
        if (v10)
            v13 = entity_40F0A0(v1, v1->field_A4);
        else
    ...
    {
        v14 = v1->stats;
        v15 = v14->field_30_hp_regen_condition ? entity_40F100(v1, v1->field_A4) : v14->field_4C != 128 ? 7424 : 4096;
        v16 = v15 + (v1->sprite->y & 0xFFFFE000) - v1->sprite->y;
        v17 = v1->stats;
        v18 = v17->field_30_hp_regen_condition;
        if (v16 <= 0)
        {
            v21 = v18 ? entity_40F100(v1, v1->field_A4) : v17->field_4C != 128 ? 7424 : 4096;
            v20 = v1->sprite->y - (v1->sprite->y & 0xFFFFE000) - v21;
        }
        else
        {
            v19 = v18 ? entity_40F100(v1, v1->field_A4) : v17->field_4C != 128 ? 7424 : 4096;
...
void entity_mode_418590(Entity *a1)
{
    ...
    {
        if (v1->entity_8 == v1->entity_E0_outpost_clanhall)
        {
            v1->entity_E0_outpost_clanhall = 0;
            entity_4133D0(v1);
            return;
    ...
    v4 = v1->stats;
    v1->mobd_lookup_idx = v3;
    v5 = v4->mobd_lookup_table_offset;
    if (v5 == -1)
        sprite_4272E0_load_mobd_item(v1->sprite, v4->mobd_lookup_offset, _47D3C4_entity_mobd_lookup_ids[v3 + 1]);
    else
        sprite_4272E0_load_mobd_item(v1->sprite, v5, _47D3C4_entity_mobd_lookup_ids[v3 + 1]);
    ...
    if (v6 && _47C048_unit_bomberdmg < 200)
    {
        ...
        v9 = v7;
        if (v8 != -1)
            sprite_4272E0_load_mobd_item(v7, v8, _47D3C4_entity_mobd_lookup_ids[v1->mobd_lookup_idx + 1]);
        v10 = v9->script;
    ...
    if (v1->field_DC == 8)
    {
        v12 = v1->sprite_width_2;
        v13 = v1->sprite;
        v14 = v13->x >> 13;
        if ((v1->sprite_width_2 >> 13) - v14 <= 0)
            v15 = v14 - (v1->sprite_width_2 >> 13);
        else
            v15 = (v1->sprite_width_2 >> 13) - v14;
        v16 = v13->y;
        v17 = v1->sprite_height_2;
        v18 = v16 >> 13;
        if ((v1->sprite_height_2 >> 13) - v18 <= 0)
            v19 = v18 - (v1->sprite_height_2 >> 13);
        else
            v19 = (v1->sprite_height_2 >> 13) - v18;
        if (v15 + v19 > 5)
        {
            v1->field_DC = 1;
            v1->sprite_width = v12;
            v1->sprite_height = v17;
            v1->entity_E0_outpost_clanhall = 0;
            entity_mode_415AB0(v1);
        }
    }
...
void entity_4187F0(Entity *a1)
{
    ...
    v4 = v1->sprite;
    v1->sprite_height = v3;
    v5 = _42D560_get_mobd_lookup_id_rotation(v1->sprite_width - v4->x, v3 - v4->y);
    v6 = v1->stats;
    v1->mobd_lookup_idx = v5;
    sprite_4272E0_load_mobd_item(v1->sprite, v6->_38_mobd_lookup_table_offset, _47D3C4_entity_mobd_lookup_ids[v5 + 1]);
    v1->sprite->field_1C_speed = v1->stats->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]] >> 6;
    v1->sprite->field_20_neg_speed = -(v1->stats->speed * _4731C8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]]) >> 6;
    v1->mode = v1->mode_arrive;
}
...
void entity_mode_418B30(Entity *a1)
{
    ...
    if (v7 <= 0)
        v7 = v5 - v6;
    if (v7 >= 512 || ((v8 = v1->sprite_height, v4->y - v8 <= 0) ? (v9 = v8 - v4->y) : (v9 = v4->y - v8), v9 >= 512))
    {
        v18 = _42D560_get_mobd_lookup_id_rotation(v5 - v6, v1->sprite_height - v4->y);
        v19 = v1->sprite;
        v1->mobd_lookup_idx = v18;
        sprite_4273B0_load_mobd_item_sound(
            v19,
            v1->stats->_38_mobd_lookup_table_offset,
            _47D3C4_entity_mobd_lookup_ids[v18 + 1]);
        v1->sprite->field_1C_speed = v1->stats->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]] >> 6;
        v1->sprite->field_20_neg_speed = -(v1->stats->speed
            * _4731C8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]]) >> 6;
        return;
    ...
    if (v10)
    {
        ...
        if (v11)
        {
            if (v11 == v1->entity_E0_outpost_clanhall_entity_id)
            {
                v12 = 0;
                ...
                if (!v12)
                    v14 = script_418A10;
                v15 = script_create_coroutine(SCRIPT_TYPE_INVALID, v14, 0);
                ...
                if (v15)
                    v15->param = v1->entity_E0_outpost_clanhall;
                v17 = v1->script;
                v1->destroyed = 1;
...
void entity_mode_418D20(Entity *a1)
{
    ...
    if (v2 && (v3 = v2->entity_id) != 0 && v3 == a1->entity_E0_outpost_clanhall_entity_id)
    {
        ...
        if (v7 >= 512 || ((v8 = v1->sprite_height, v4->y - v8 <= 0) ? (v9 = v8 - v4->y) : (v9 = v4->y - v8), v9 >= 512))
        {
            v11 = _42D560_get_mobd_lookup_id_rotation(v5 - v6, v1->sprite_height - v4->y);
            v12 = v1->stats;
            v1->mobd_lookup_idx = v11;
            sprite_4273B0_load_mobd_item_sound(
                v1->sprite,
                v12->_38_mobd_lookup_table_offset,
...
void entity_mode_418E90(Entity *a1)
{
    ...
    if ((int)v2 <= 0)
    {
        ...
        a1->sprite->field_1C_speed = 0;
        a1->sprite->field_20_neg_speed = 0;
        v3 = a1->entity_E0_outpost_clanhall;
        if (v3)
        {
            v4 = v3->entity_id;
            if (v4)
            {
                if (v4 == v1->entity_E0_outpost_clanhall_entity_id && v3->script->script_type == SCRIPT_REPAIR_STATION_HANDLER)
                    *((_DWORD *)v3->state + 2) = 0;
            }
        }
        if (v1->field_DC == 1)
...
void entity_mode_418F60(Entity *a1)
{
    ...
    v2->field_1C_speed = -64;
    v1->sprite->field_20_neg_speed = 64;
    sprite_4272E0_load_mobd_item(
        v1->sprite,
        v1->stats->_38_mobd_lookup_table_offset,
        _47D3C4_entity_mobd_lookup_ids[v1->mobd_lookup_idx + 1]);
    v3 = v1->entity_E0_outpost_clanhall;
    ...
    if (v3)
    {
        ...
        if (v4)
        {
            if (v4 == v1->entity_E0_outpost_clanhall_entity_id)
            {
                v5 = v3->turret;
                if (v5)
...
void entity_mode_418FE0(Entity *a1)
{
    ...
    v2 = 1;
    v3 = a1->entity_E0_outpost_clanhall;
    if (!v3 || (v4 = v3->entity_id) == 0 || v4 != v1->entity_E0_outpost_clanhall_entity_id)
    {
        v1->hitpoints = 0;
        v1->destroyed = 1;
...
LABEL_20:
    ...
    if (v1->hitpoints >= v9)
    {
        ...
        v10 = v1->sprite;
        v1->mode = entity_mode_418E90;
        v10->field_1C_speed = -64;
        v1->sprite->field_20_neg_speed = 64;
        sprite_4272E0_load_mobd_item(
            v1->sprite,
            v1->stats->_38_mobd_lookup_table_offset,
            _47D3C4_entity_mobd_lookup_ids[v1->mobd_lookup_idx + 1]);
        v11 = v1->entity_E0_outpost_clanhall;
        v1->_128_spawn_param = (void *)100;
        if (v11)
        {
            v12 = v11->entity_id;
            if (v12)
            {
                if (v12 == v1->entity_E0_outpost_clanhall_entity_id)
                {
                    v13 = v11->turret;
                    if (v13)
...
LABEL_27:
    script_445370_yield(v1->script, 0x80000000, 4 * v2);
}
...
void entity_mode_419180(Entity *a1)
{
    ...
    if (v2 && (v3 = v2->entity_id) != 0 && v3 == a1->entity_E0_outpost_clanhall_entity_id)
    {
        ...
        if ((int)v4 <= 0)
        {
            a1->sprite->field_1C_speed = 0;
            a1->sprite->field_20_neg_speed = 0;
            v5 = a1->mobd_lookup_idx;
            v6 = a1->stats;
            a1->mode = entity_mode_418FE0;
            sprite_4272E0_load_mobd_item(a1->sprite, v6->mobd_lookup_offset, _47D3C4_entity_mobd_lookup_ids[v5 + 1]);
...
void entity_mode_419230(Entity *a1)
{
    ...
    sprite_4272E0_load_mobd_item(
        ...
        a1->stats->mobd_lookup_offset,
        _47D3C4_entity_mobd_lookup_ids[a1->mobd_lookup_idx + 1]);
    if (!_44CB60_advance_mobd_frame(v2, 160, v1->stats->turning_speed))
    {
        v1->sprite->field_1C_speed = 64;
        v1->sprite->field_20_neg_speed = -64;
        sprite_4272E0_load_mobd_item(
            v1->sprite,
            v1->stats->_38_mobd_lookup_table_offset,
...
char *entity_4192F0(Entity *a1)
{
    ...
    if (v3)
    {
        ...
        if (!((v10->x ^ (v6 + v8->x)) & 0xFFFFE000) && (char *)(v10->y >> 13) == result)
            result = entity_40DEC0_boxd(v1, v1->sprite_width_shr13, v1->sprite_height_shr13, v1->field_A4);
    }
    return result;
}
...
void entity_mode_419390_oiltanker(Entity *a1)
{
    ...
    if (v3 && v3->entity_id == v2->_18_entity_id)
    {
        ...
        {
            script_445370_yield(v1->script, 0x80000000, 30);
        }
        else
        {
            *(_DWORD *)(v4 + 24) = (int)v1;
...
void entity_mode_419420(Entity *a1)
{
    ...
    v1 = a1;
    v2 = a1->mode;
    v3 = a1->stats->_38_mobd_lookup_table_offset;
    v19 = _47D3C4_entity_mobd_lookup_ids[a1->mobd_lookup_idx + 1];
    v4 = a1->sprite;
    if (v2 == entity_mode_419420)
    {
        sprite_4273B0_load_mobd_item_sound(v4, v3, v19);
    }
    else
    {
        sprite_4272E0_load_mobd_item(v4, v3, v19);
        v1->mode = entity_mode_419420;
    }
    v5 = v1->stats;
    if (v5->field_30_hp_regen_condition)
        v6 = entity_40F0A0(v1, v1->field_A4);
        ...
        v6 = v5->field_4C != 128 ? 7424 : 4096;
    v7 = v6 + (v1->sprite_width_shr13 << 13);
    v8 = v1->stats;
    if (v8->field_30_hp_regen_condition)
        v9 = entity_40F100(v1, v1->field_A4);
    else
        v9 = v8->field_4C != 128 ? 7424 : 4096;
    v10 = v1->sprite;
    v11 = v9 + (v1->sprite_height_shr13 << 13);
    v12 = v10->x;
    v13 = v7 - v12;
    if (v7 - v12 <= 0)
        v14 = v12 - v7;
    ...
    if (v14 >= 768 || ((v15 = v10->y, v11 - v15 <= 0) ? (v16 = v15 - v11) : (v16 = v11 - v15), v16 >= 768))
    {
        ...
        v18 = v1->stats;
        v1->mobd_lookup_idx = v17;
        v1->sprite->field_1C_speed = v18->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v17 + 1]] >> 6;
        v1->sprite->field_20_neg_speed = -(v1->stats->speed
            * _4731C8_speeds[__47CFC4_mobd_lookup_speeds[v1->mobd_lookup_idx + 1]]) >> 6;
    }
    else
...
void entity_419560_on_death(Entity *a1)
{
    ...
    sprite_4272E0_load_mobd_item(
        ...
        _47D3C4_entity_mobd_lookup_ids[v1->mobd_lookup_idx + 1]);
LABEL_15:
    script_445370_yield(v1->script, 0x80000000, 60);
}
...
void entity_mode_4197E0_infantry(Entity *a1)
{
    ...
    a1->sprite->field_1C_speed = 0;
    a1->sprite->field_20_neg_speed = 0;
    v2 = a1->mobd_lookup_idx + 64;
    v3 = a1->sprite;
    v1->mobd_lookup_idx = v2;
    sprite_4272E0_load_mobd_item(v3, v1->stats->_38_mobd_lookup_table_offset, _47D3C4_entity_mobd_lookup_ids[v2 + 1]);
...
void EventHandler_General_Scout(Script *receiver, Script *sender, enum SCRIPT_EVENT event, void *param)
{
    ...
    if (!v4->destroyed)
    {
        ...
        case EVT_MSG_1507_stru11:
            ...
            break;
        case EVT_MSG_1508:
            if (v4->field_DC != 5 || v4->_E8_entity != param)
            {
                script_trigger_event(v4->script, EVT_MSG_1509_stru11, v4, *((Script **)param + 3));
            }
            else if (!v4->entity_E0_outpost_clanhall && !v4->entity_8)
            {
                v4->entity_E0_outpost_clanhall = (Entity *)*((_DWORD *)param + 70);
                v4->entity_E0_outpost_clanhall_entity_id = *(_DWORD *)(*((_DWORD *)param + 70) + 304);
                entity_mode_415AB0(v4);
            }
            break;
        ...
        case EVT_MSG_1546:
            ...
            v13 = *((_DWORD *)param + 76);
            v4->_E4_entity = 0;
            v4->entity_E0_outpost_clanhall_entity_id = v13;
            v4->_134_param__unitstats_after_mobile_outpost_plant = 600;
            v4->mode_arrive = entity_mode_419230;
            *(_DWORD *)(*((_DWORD *)param + 23) + 136) = 1;
            v4->sprite_width_2 = *(_DWORD *)(*((_DWORD *)param + 23) + 16) + *(_DWORD *)(*((_DWORD *)param + 29) + 4);
            v14 = *(_DWORD *)(*((_DWORD *)param + 29) + 8);
            v15 = *(_DWORD *)(*((_DWORD *)param + 23) + 20);
            v4->entity_8 = 0;
            v4->sprite_height_2 = v15 + v14;
            entity_40DF50_boxd(v4, 1);
            v4->mode = entity_mode_415AB0;
            break;
        case EVT_MSG_1547:
