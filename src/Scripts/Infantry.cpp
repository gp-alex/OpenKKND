...
void entity_init_infantry(Entity *a1)
{
    ...
    else if (entity_413860_boxd(a1))
    {
        ...
        v1->sprite->y_speed = -(v1->stats->speed
...
void entity_414C30_boxd(Entity *a1)
{
    ...
    if (v2 & 0x3F)
    {
        ...
        v1->sprite->x_speed = 0;
        v1->sprite->y_speed = -(v1->stats->speed * _4731C8_speeds[__47CFC4_mobd_lookup_speeds[v3 + 1]]) >> 6;
        if (entity_40DA90_boxd(v1) == 4)
        {
            v10 = v1->sprite;
            if (v10->y_speed <= 0)
...
void entity_mode_415540_infantry(Entity *a1)
{
    ...
    v1->sprite_height = v8;
    v7->x_speed = v9 - v7->x;
    v1->sprite->y_speed = v1->sprite_height - v1->sprite->y;
    if (entity_40DA90_boxd(v1) == 4)
    {
        ...
        if (v1->stats->field_30_hp_regen_condition)
        {
            ...
            LABEL_35:
                if (v18 == 3)
                {
                    ...
                    v21 = v1->sprite;
                    v1->stru224._2C_map_x = v21->x_speed;
                    v1->stru224._30_map_y = v21->y_speed;
                    v21->x_speed = 0;
                    v1->sprite->y_speed = 0;
                    v22 = v1->field_124;
