...
void *script_handlers[353] =
{
	...
	&script_438B80_on_death_explosion,
...
char super_lvl[10] = "super.lvl"; // weak
...
char *aSLevelsSSprite = "%s\\LEVELS\\%s\\sprites.lvl";
char *aSFmvS = "%s\\FMV\\%s";
...
char aYouCanOnlyBuild1OfThese[] = "You can only build 1 of these"; // idb
char aYouCanOnlyBuild4OfThese[] = "You can only build 4 of these"; // idb
...
BuildingLimits *building_limits_list = NULL;
BuildingLimits *building_limits_list_free_pool = NULL;
