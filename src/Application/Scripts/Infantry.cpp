...
void UNIT_Handler_VehiclesInfantry(Script *a1)
{
    ...
    if (!_47C6DC_dont_execute_unit_handlers)
    {
        ...
        v2 = v1->sprite;
        v3 = v2->x;
        if (v3 < 0 || v3 >= map2global(map_get_width()) || (v4 = v2->y, v4 < 0) || v4 >= map2global(map_get_height()))
        {
            v1->sprite->x = 100 * 256;
            v1->sprite->y = 100 * 256;
            v1->SetMode(entity_mode_419760_infantry_destroyed);
        }
...
void entity_init_infantry(Entity *a1)
{
    ...
    if (a1->sprite->cplc_ptr1)
    {
        ...
        v10 = map_place_entity(
            v1, map_adjust_entity_in_tile_x(a1, a1->sprite->x), map_adjust_entity_in_tile_y(a1, v1->sprite->y), 0
        );
    ...
    {
        v1->sprite_x = map_adjust_entity_in_tile_x(v1, map2global(v1->sprite_map_x));
        v1->sprite_y = map_adjust_entity_in_tile_y(v1, map2global(v1->sprite_map_y));
        v1->_DC_order = ENTITY_ORDER_MOVE;
        ...
        v24 = v1->sprite_y;
        v25 = v1->sprite_x;
        v1->mode_return = entity_mode_adjust_unit_placement_inside_tile;
        ...
        v1->SetMode(entity_mode_417360_infantry);
    }
    else
    {
        v1->sprite->x_speed = 0;
...
bool entity_413120_can_fire_on_entity(Entity *a1, Entity *a2, int entity_id)
{
    ...
    return distance <= v30 && entity_41B510(a1, a2);
}
    ...
    LABEL_19:
        if (!v1->stats->attach)
        {
            ...
            if (v13 != UNIT_STATS_SURV_MOBILE_OUTPOST
                ...
                && (v13 != UNIT_STATS_SURV_SABOTEUR || v1->GetOrder() != ENTITY_ORDER_3)
                && (v13 != UNIT_STATS_MUTE_VANDAL || v1->GetOrder() != ENTITY_ORDER_3)
                && (v13 != UNIT_STATS_SURV_TECHNICIAN || v1->GetOrder() != ENTITY_ORDER_3)
                && (v13 != UNIT_STATS_MUTE_MEKANIK || v1->GetOrder() != ENTITY_ORDER_3))
            {
                ...
                if (v14)
                {
                    ...
                    if (v15)
                    {
                        if (v15 == v1->_E4_prev_attack_target_entity_id
                            ...
                            && entity_413120_can_fire_on_entity(v1, v14, v1->_E4_prev_attack_target_entity_id)
...
bool entity_413860_boxd(Entity *a1)
{
    ...
    v11 = v1->stats;
    if (v11->is_infantry)
        v12 = map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile);
    else
        v12 = v11->field_4C != 128 ? 7424 : 4096;
    v13 = v1->stats;
    if (v13->is_infantry)
        v14 = map_get_entity_placement_inside_tile_x(v1, v1->_A4_idx_in_tile);
    else
    ...
    v1->sprite_map_y = v2;
    if (v16->is_infantry)
        v17 = map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile);
    else
        v17 = v16->field_4C != 128 ? 7424 : 4096;
    v18 = v1->stats;
    if (v18->is_infantry)
        v19 = map_get_entity_placement_inside_tile_x(v1, v1->_A4_idx_in_tile);
    else
...
bool entity_413A90_boxd(Entity *a1)
{
    ...
    while (boxd_40EA50_classify_tile_objects(a1a, v2, v3, v5) != 2)
    {
        if (v14 & 1)
        {
            v2 += v4;
    ...
    a1a->sprite_map_y = v3;
    if (v10->is_infantry)
        v11 = map_get_entity_placement_inside_tile_y(a1a, a1a->_A4_idx_in_tile);
    else
        v11 = v10->field_4C != 128 ? 7424 : 4096;
    v12 = a1a->stats;
    if (v12->is_infantry)
        v13 = map_get_entity_placement_inside_tile_x(a1a, a1a->_A4_idx_in_tile);
    else
...
int entity_413C10(Entity *a1)
{
    ...
    if (result != 2)
    {
        ...
        v6 = v9 & 0xE0;
    LABEL_7:
        result = boxd_40EA50_classify_tile_objects(
            v1,
...
bool entity_initialize_order(Entity *a1)
{
    ...
    case ENTITY_ORDER_MOVE:
        ...
        if (!map_is_same_tile(v11, v13->x) || !map_is_same_tile(v12, v13->y))
        {
    ...
    case ENTITY_ORDER_9:
        ...
        v1->sprite_x = v28;
        v1->sprite_y = v29;
        if (!map_is_same_tile(v28, v30->x) || map_is_same_tile(v29, v30->y))
            goto LABEL_35;
        v1->SetReturnMode(entity_mode_adjust_unit_placement_inside_tile);
        entity_mode_416A70_infantry(v1);
    ...
    case ENTITY_ORDER_7:
        ...
        {
            v1->sprite_x = map_adjust_entity_in_tile_x(v1, v1->sprite->x);
            v1->sprite_y = map_adjust_entity_in_tile_y(v1, v1->sprite->y);
            v1->SetMode(entity_mode_416A70_infantry);
            return true;
        }
    ...
    case ENTITY_ORDER_3:
        ...
        v53 = v51->y >> 13;
        v54 = v52 >> 13;
        v55 = (char *)& _478AA8_boxd_stru0_array[v54]._4_entities[6 * map_get_width() * v53];
        if (*(Entity **)v55 == v47)
        {
            v56 = 24 * map_get_width();
            do
            {
                v57 = *(Entity **)&v55[v56];
                v55 += v56;
        ...
        if (v65 - v96 <= 0)
            v67 = v96 - v65;
        if (v67 > 1 || !_478AA8_boxd_stru0_array[v64]._4_entities[6 * map_get_width() * v65])
            goto LABEL_35;
    LABEL_79:
        entity_4187F0(v1);
        return 1;
...
void entity_414440_boxd(Entity *a1, int *a2, int *a3)
{
    ...
    if (entity_is_xl_vehicle(a1))
    {
        v4 = *a2 >> 13;
        v5 = *a3 >> 13;
        v6 = boxd_get_tile(v4, v5);
        if (!boxd_40EA50_classify_tile_objects(a1, v4, v5, v6))
        {
            if (boxd_40EA50_classify_tile_objects(v3, v4 - 1, v5, v6 - 1))
            {
                *v8 -= 0x2000;
                return;
            }
            v7 = v5 - 1;
            if (!boxd_40EA50_classify_tile_objects(v3, v4, v7, &v6[-map_get_width()]))
            {
                if (!boxd_40EA50_classify_tile_objects(v3, v4 - 1, v7, &v6[-(map_get_width() + 1)]))
                    return;
                *v8 -= 0x2000;
            }
            *a3 -= 0x2000;
...
bool entity_414520_boxd(Entity *a1)
{
    ...
    if (v4 < v4 + v2)
    {
        while (v5 < map_get_height())
        {
            v6 = v3;
            v7 = boxd_get_tile(v3, v5);
            v13 = boxd_get_tile(v3, v5);
            if (v3 < v14 + v3)
            {
                while (2)
                {
...
void entity_414670(Entity *a1)
{
    ...
    v3 = a1->entity_8;
    if ((!v3 || v3->entity_id != a1->entity_118_entity_id) && !entity_413120_can_fire_on_entity(a1, a1->_E4_prev_attack_target, a1->_E4_prev_attack_target_entity_id))
    {
        v4 = v1->stats;
        v1->_E4_prev_attack_target = 0;
        v5 = v1->sprite;
        ...
        {
            if (v11 >= map_get_height())
                break;
            v12 = v7;
            v13 = boxd_get_tile(v7, v11);
            v20 = boxd_get_tile(v7, v11);
            if (v7 < v21 + v7)
            {
                while (2)
                {
            ...
            while (1)
            {
                ...
                if (v18)
                {
                    if (is_enemy(v1->player_side, v18)
                        && entity_413120_can_fire_on_entity(v1, v17->param__entity__int, v17->param__entity__int->entity_id))
                    {
                        break;
                    }
                }
...
void entity_4149A0(Entity *a1)
{
    ...
    if (abs(a1->sprite->x - some_x) > 0x10000 || abs(a1->sprite->y - some_y) > 0x10000)
    {
        ...
        a1->sprite_x_2 = some_x;
        a1->sprite_y_2 = some_y;
...
bool entity_414AD0_vehicle_collide_vehicle(Entity *a1)
{
    ...
    v7 = boxd_40EA50_classify_tile_objects(v1, map_x, map_y, v6);
    if (v7 < 0)
        return 0;
    if (v7 <= 1)
    {
    ...
    if (v7 != 3)
        return 0;
    v1->pathing._2C_waypoint_map_x = map_x;
    v8 = 0;
    v1->pathing._2C_waypoint_map_y = map_y;
    v9 = v6->_4_entities;
    while (1)
    {
        if (*v9)
...
LABEL_18:
    ...
    if (entity_is_regular_vehicle(v1))
    {
        ...
        v11 = boxd_40EA50_classify_tile_objects(v1, v9 >> 13, v10, boxd_get_tile(v9 >> 13, v10));
    }
    else
    {
        v11 = 2;
    ...
    if (v11 == 2 || v11 == 3)
    {
        ...
        case 0x40:
        LABEL_39:
            v1->sprite_x = map_adjust_entity_in_tile_x(v1, v1->sprite->x + 0x2000);
            v1->sprite_y = v1->sprite->y;
            break;
    ...
    else
    {
        ...
        if (entity_is_regular_vehicle(v1))
        {
            ...
            v16 = boxd_40EA50_classify_tile_objects(
                v1,
                global2map(v14),
                global2map(v15),
                boxd_get_tile(global2map(v14), global2map(v15))
            );
        }
        else
        {
...
bool entity_415400_tanker_order7(Entity *a1)
{
    ...
    v1 = a1;
    v2 = a1->unit_id;
    if (v2 != UNIT_STATS_SURV_TANKER && v2 != UNIT_STATS_MUTE_TANKER || a1->GetOrder() != ENTITY_ORDER_7)
        return 0;
    ...
    if (v4 && v4->entity_id == v3->_18_entity_id)
    {
        if (*((Entity **)v4->state + 6) != v1)
        {
            ...
            if (math_42D64D_vec_length_2d(v11 >> 8, v8 >> 8) < 128)
            {
                entity_4192F0(v1);
                return true;
            }
...
//----- (00415540) --------------------------------------------------------
// when unit reaches destination, ajust its placement in the tile
void entity_mode_adjust_unit_placement_inside_tile(Entity *a1)
{
    ...
    entity_load_idle_mobd(v1);
    v1->SetMode(entity_mode_default_idle);
...
void entity_mode_default_idle(Entity *a1)
{
    ...
    if (a1->IsInfantry())
    {
        if (SLOWORD_HEXRAYS(v1->field_29C) > 50)
        {
            int rnd = kknd_rand_3();
            if (!(_BYTE)rnd)
                v1->SetMode(entity_mode_4157F0_infantry_idle_fidgeting);
        }
    }
    ...
    else if (v1->script->script_type != SCRIPT_TANKER_CONVOY_HANDLER || v1->_DC_order != ENTITY_ORDER_7)
    {
        v8 = v1->_E8_entity;
        if (v8)
        {
...
void entity_mode_415980(Entity *a1)
{
    ...
    else
    {
        ...
        a1->mode_return = entity_mode_adjust_unit_placement_inside_tile;
        entity_mode_416A70_infantry(a1);
    }
}
...
void entity_415A20(Entity *a1)
{
    ...
    a1->sprite->x_speed = 0;
    a1->sprite->y_speed = 0;
    a1->SetMode(entity_mode_rotate_to_target_415A60);
}
...
void entity_mode_attack_move_1_415D30(Entity *a1)
{
    ...
    if (v2 < 0)
    {
        if (a1->pathing.field_54)
        {
            if (a1->pathing.destination_map_x || a1->pathing.destination_map_y)
            {
                v16 = a1->stats;
                if (v16->is_infantry)
                    v17 = map_get_entity_placement_inside_tile_x(a1, a1->_A4_idx_in_tile);
                else
                    v17 = v16->field_4C != 128 ? 7424 : 4096;
                v18 = v17 + (v1->pathing.destination_map_x << 13);
                v19 = v1->stats;
                v1->sprite_x = v18;
                if (v19->is_infantry)
                    v20 = map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile);
                else
                    v20 = v19->field_4C != 128 ? 7424 : 4096;
                v1->sprite_y = v20 + (v1->pathing.destination_map_y << 13);
    ...
    {
        a1->pathing._2C_waypoint_map_x = a1->_15C_waypoints_xs[v2];
        a1->pathing._2C_waypoint_map_y = a1->_15C_waypoints_ys[v2];
        a1->pathing._34_waypoint_map_x = a1->_15C_waypoints_xs[v2];
        a1->pathing._34_waypoint_map_y = a1->_15C_waypoints_ys[v2];
        if (a1->pathing._2C_waypoint_map_x == -1 && a1->pathing._2C_waypoint_map_y == -1)
        {
            if (v2)
                a1->pathing.num_waypoints = v2 - 1;
            v3 = a1->pathing.num_waypoints;
            a1->pathing._2C_waypoint_map_x = a1->_15C_waypoints_xs[v3];
            a1->pathing._2C_waypoint_map_y = a1->_15C_waypoints_ys[v3];
            a1->pathing._34_waypoint_map_x = a1->_15C_waypoints_xs[v3];
            a1->pathing._34_waypoint_map_y = a1->_15C_waypoints_ys[v3];
        }
        
        int tile_classf = boxd_40EA50_classify_tile_objects(
            a1,
            a1->pathing._2C_waypoint_map_x,
            a1->pathing._2C_waypoint_map_y,
            boxd_get_tile(a1->pathing._2C_waypoint_map_x, a1->pathing._2C_waypoint_map_y)
        );
        if (tile_classf == 2
            && boxd_41C130(
                map_adjust_entity_in_tile_x(v1, map2global(v1->pathing._2C_waypoint_map_x)),
                map_adjust_entity_in_tile_y(v1, map2global(v1->pathing._2C_waypoint_map_y)),
                v1->sprite->x,
                v1->sprite->y,
                v1
            )
        ...
        {
            v1->sprite_x = map_adjust_entity_in_tile_x(v1, map2global(v1->pathing._2C_waypoint_map_x));
            v1->sprite_y = map_adjust_entity_in_tile_y(v1, map2global(v1->pathing._2C_waypoint_map_y));
            entity_mode_attack_move_2_5_4165C0(v1);
        }
        else
        {
            v13 = ((_42D560_get_mobd_lookup_id_rotation(
                v1->_1AC_waypoints_xs[v1->pathing.num_waypoints] - v1->_15C_waypoints_xs[v1->pathing.num_waypoints],
                v1->_1AC_waypoints_ys[v1->pathing.num_waypoints] - v1->_15C_waypoints_ys[v1->pathing.num_waypoints])
                + 16) >> 5) & 7;
            v1->field_140 = 0;
            v1->SetMode(entity_mode_416060);
            v14 = (v13 + 2) & 7;
            v1->pathing._40_xy_idx = (v13 - 2) & 7;
            v15 = v1->field_124;
            v1->pathing.field_3C = v14;
...
void entity_mode_416060(Entity *a1)
{
    ...
    while (1)
    {
        if (v1->field_124 & 8)
        {
            v2 = v1->pathing._2C_waypoint_map_x;
            v3 = &v1->pathing._2C_waypoint_map_y;
            v4 = &v1->pathing._2C_waypoint_map_x;
            v48 = v1->pathing._2C_waypoint_map_y;
            v47 = v2;
            if (boxd_44D340(&v1->pathing._2C_waypoint_map_x, &v1->pathing._2C_waypoint_map_y, 1, v1, &v1->pathing.field_3C))
            {
                v5 = v1->sprite;
                ...
                v6 = boxd_40EA50_classify_tile_objects(v1, *v4, *v3, boxd_get_tile(*v4, *v3));
                if (v6 == 2 || v6 == 3)
                {
                    v7 = v1->stats;
                    v8 = v7->is_infantry ? map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile) : v7->field_4C != 128 ? 7424 : 4096;
                    v9 = v1->stats;
                    v10 = v9->is_infantry ? map_get_entity_placement_inside_tile_x(v1, v1->_A4_idx_in_tile) : v9->field_4C != 128 ? 7424 : 4096;
                    if (boxd_41C130(v10 + (*v4 << 13), v8 + (*v3 << 13), v1->sprite->x, v1->sprite->y, v1))
                    {
                        v32 = v1->stats;
                        if (v32->is_infantry)
                            v33 = map_get_entity_placement_inside_tile_x(v1, v1->_A4_idx_in_tile);
                        else
                            v33 = v32->field_4C != 128 ? 7424 : 4096;
                        v34 = v33 + (v1->pathing._2C_waypoint_map_x << 13);
                        v35 = v1->stats;
                        v1->sprite_x = v34;
                        if (v1->IsInfantry())
                        {
                            v36 = map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile);
                            v37 = v1->pathing._2C_waypoint_map_y;
                        }
                        else
                        {
                            v37 = v1->pathing._2C_waypoint_map_y;
                ...
                {
                    v11 = v1->pathing._34_waypoint_map_x;
                    if (*v4 == v11 && *v3 == v1->pathing._34_waypoint_map_y)
                    {
                        v12 = v1->pathing._40_xy_idx;
                        out_y = v1->pathing._34_waypoint_map_y;
                        out_x = v11;
                        a5 = v12;
        ...
        {
            v14 = v1->pathing._34_waypoint_map_x;
            v15 = &v1->pathing._34_waypoint_map_y;
            v16 = &v1->pathing._34_waypoint_map_x;
            v47 = v1->pathing._34_waypoint_map_y;
            v48 = v14;
            if (boxd_44D340(&v1->pathing._34_waypoint_map_x, &v1->pathing._34_waypoint_map_y, 0, v1, &v1->pathing._40_xy_idx))
            {
                v17 = v1->sprite;
                if (*v16 == v17->x >> 13 && *v15 == v17->y >> 13)
                    goto LABEL_63;
                v18 = boxd_40EA50_classify_tile_objects(v1, *v16, *v15, boxd_get_tile(*v16, *v15));
                if (v18 == 2 || v18 == 3)
                {
                    v19 = v1->stats;
                    v20 = v19->is_infantry ? map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile) : v19->field_4C != 128 ? 7424 : 4096;
                    v21 = v1->stats;
                    v22 = v21->is_infantry ? map_get_entity_placement_inside_tile_x(v1, v1->_A4_idx_in_tile) : v21->field_4C != 128 ? 7424 : 4096;
                    if (boxd_41C130(v22 + (*v16 << 13), v20 + (*v15 << 13), v1->sprite->x, v1->sprite->y, v1))
                    {
                        v38 = v1->stats;
                        if (v38->is_infantry)
                            v39 = map_get_entity_placement_inside_tile_x(v1, v1->_A4_idx_in_tile);
                        else
                            v39 = v38->field_4C != 128 ? 7424 : 4096;
                        v40 = v39 + (v1->pathing._34_waypoint_map_x << 13);
                        v41 = v1->stats;
                        v1->sprite_x = v40;
                        if (v41->is_infantry)
                            v36 = map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile);
                        ...
                        v37 = v1->pathing._34_waypoint_map_y;
                    LABEL_71:
                ...
                if (v1->field_124 & 0x20)
                {
                    v23 = v1->pathing._2C_waypoint_map_x;
                    if (v23 == *v16 && v1->pathing._2C_waypoint_map_y == *v15)
                    {
                        v24 = v1->pathing.field_3C;
                        out_y = v1->pathing._2C_waypoint_map_y;
                        out_x = v23;
                        a5 = v24;
        ...
        v26 = v1->pathing._2C_waypoint_map_x;
        v27 = v1->pathing._34_waypoint_map_x;
        if (v26 != v27 || v1->pathing._2C_waypoint_map_y != v1->pathing._34_waypoint_map_y)
        {
            v28 = v1->field_124;
        ...
        if (v29 > 20 && !(v1->field_124 & 0x20))
            break;
        if ((int *)v26 == v1->_15C_waypoints_xs && (int *)v1->pathing._2C_waypoint_map_y == v1->_15C_waypoints_ys)
            v1->field_124 &= 0xFFFFFFF7;
        if ((int *)v27 == v1->_15C_waypoints_xs && (int *)v1->pathing._34_waypoint_map_y == v1->_15C_waypoints_ys)
        {
            v30 = v1->field_124;
...
void entity_mode_attack_move_2_5_4165C0(Entity *a1)
{
    ...
    a1->_B8_move_dst_x = a1->sprite->x;
    a1->_B8_move_dst_y = a1->sprite->y;
    a1->field_124 &= ~1;
    ...
    if (a1->IsInfantry())
    {
        ...
        a1->sprite->_60_mobd_anim_speed -= kknd_rand_3() << 9;
        a1->_C0_mobd_anim_speed_related = a1->sprite->_60_mobd_anim_speed;
    }
    else if (a1->stats->field_4C == 128 || boxd_41C130(a1->sprite_x, a1->sprite_y, a1->sprite->x, a1->sprite->y, a1))
    {
        entity_load_move_mobd(a1);

        a1->sprite->_60_mobd_anim_speed -= kknd_rand_3() << 9;
        a1->_C0_mobd_anim_speed_related = a1->sprite->_60_mobd_anim_speed;
        char v7 = _42D560_get_mobd_lookup_id_rotation(
            a1->sprite_x - a1->sprite->x,
            a1->sprite_y - a1->sprite->y
        );
        a1->_88_dst_orientation = (v7 + 8) & 0xF0;
        entity_load_move_mobd(a1);

        a1->sprite->x_speed = 0;
        a1->sprite->y_speed = 0;
        a1->SetMode(entity_mode_rotate_to_target_415A60);
        a1->mode_turn_return = entity_mode_move_to_target_416790;
    }
    else if (!entity_414870_boxd(a1))
    {
        entity_mode_attack_move_4_order_3_7_417E60(a1);
    }
}
...
void entity_mode_move_to_target_416790(Entity *a1)
{
    ...
    if (entity_4135E0(a1) || entity_415400_tanker_order7(v1))
    {
        return;
    }
    ...
    v13 = v1->sprite;
    int dx = abs(v1->sprite->x - v1->_B8_move_dst_x);
    ...
    if (v1->IsInfantry())
    {
        v18 = entity_40D600_infantry_get_new_movement_orientation(v1, v1->sprite_x, v1->sprite_y, 2 * 256);
    }
    else
    {
        v18 = entity_40D6F0_vehicle_get_new_movement_orientation(v1, v1->sprite_x, v1->sprite_y, 2 * 256);
    }
...
void entity_mode_416A70_infantry(Entity *a1)
{
    ...
    if (!entity_is_xl_vehicle(a1))
    {
        ...
        if ((v1->sprite->x & 0x1FFF) < 4096) {
            v1->sprite_x = map_adjust_entity_in_tile_x_2(v1, v1->sprite->x) - 0x2000;
        } else {
            v1->sprite_x = map_adjust_entity_in_tile_x_2(v1, v1->sprite->x);
        }

        if ((v1->sprite->y & 0x1FFF) < 4096) {
            v1->sprite_y = map_adjust_entity_in_tile_y(v1, v1->sprite->y) - 0x2000;
        } else {
            v1->sprite_y = map_adjust_entity_in_tile_y(v1, v1->sprite->y);
        }
    ...
    int dx = abs(v1->sprite->x - v1->sprite_x);
    int dy = abs(v1->sprite->y - v1->sprite_y);
    if (dx >= 512 || dy >= 512)
    {
        v23 = _42D560_get_mobd_lookup_id_rotation(
            v1->sprite_x - v1->sprite->x,
            v1->sprite_y - v1->sprite->y
        );
        ...
        else
        {
            ...
            v1->SetMode(entity_mode_rotate_to_target_415A60);
            v1->mode_turn_return = entity_mode_416A70_infantry;
...
void entity_mode_416CD0(Entity *a1)
{
    ...
    if (abs(v2->x - a1->sprite_x) >= 512 || abs(v2->y - a1->sprite_y) >= 512)
    {
        ...
        if (map_40DA90_move_entity(v1) != 4)
        {
            ...
            if (!entity_is_xl_vehicle(a1))
            {
                if (map_is_entity_in_tile(global2map(a1->sprite->x), global2map(a1->sprite->y), a1)) {
                    a1->sprite->x = map_adjust_entity_in_tile_x(a1, a1->sprite->x);
                    a1->sprite->y = map_adjust_entity_in_tile_y(a1, a1->sprite->y);
                    a1->SetMode(a1->mode_return);
                }
            }
        }
    }
    ...
    {
        a1->sprite->x = a1->sprite_x;
        a1->sprite->y = a1->sprite_y;
        a1->sprite->x_speed = 0;
        a1->sprite->y_speed = 0;
        a1->SetMode(a1->mode_return);
    }
...
void entity_mode_416EB0(Entity *a1)
{
    ...
    if (!entity_is_xl_vehicle(a1)) {
        ...
        if ((a1->sprite->x & 0x1FFF) < 4096) {
            a1->sprite_x = map_adjust_entity_in_tile_x_2(a1, a1->sprite->x) - 0x2000;
        } else {
            a1->sprite_x = map_adjust_entity_in_tile_x_2(a1, a1->sprite->x);
        }

        if ((a1->sprite->y & 0x1FFF) < 4096) {
            a1->sprite_y = map_adjust_entity_in_tile_y(a1, a1->sprite->y);
        } else {
            a1->sprite_y = map_adjust_entity_in_tile_y(a1, a1->sprite->y) - 0x2000;
        }
    }

    if (abs(a1->sprite->x - a1->sprite_x) >= 1792 || abs(a1->sprite->y - a1->sprite_y))
    {
        int v23 = _42D560_get_mobd_lookup_id_rotation(
            a1->sprite_x - a1->sprite->x,
            a1->sprite_y - a1->sprite->y
        );
        ...
        {
            a1->_88_dst_orientation = v23;
            a1->SetTurnReturnMode(entity_mode_416EB0);
...
{
    if (abs(a1->sprite->x - a1->sprite_x) >= 1792 || abs(a1->sprite->y - a1->sprite_y) >= 1792)
    {
        entity_load_move_mobd(
            a1,
            _42D560_get_mobd_lookup_id_rotation(
                a1->sprite_x - a1->sprite->x,
                a1->sprite_y - a1->sprite->y
...
void entity_4172D0(Entity *a1)
{
    ...
    entity_load_move_mobd(a1, v2);
    a1->sprite->x_speed = a1->stats->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[v2 + 1]] >> 6;
    a1->sprite->y_speed = -entity_get_mobd_speed_y(a1);
    a1->SetMode(entity_mode_417360_infantry);
}
...
void entity_mode_attack_move_4_417550(Entity *a1)
{
    ...
    v6 = v5;
    v7 = v1->field_13C;
    v1->pathing._34_waypoint_map_x = v6;
    v1->pathing._2C_waypoint_map_x = v6;
    v1->pathing._34_waypoint_map_y = v7;
    v1->pathing._2C_waypoint_map_y = v7;
    v8 = _42D560_get_mobd_lookup_id_rotation(v3 - v6, v4 - v7);
    v9 = v1->field_CC;
    LOBYTE_HEXRAYS(v8) = ((v8 + 16) >> 5) & 7;
    v1->pathing.field_3C = ((_BYTE)v8 + 2) & 7;
    v10 = v1->field_138;
    v1->pathing._40_xy_idx = ((_BYTE)v8 - 2) & 7;
    v11 = v9 - v10;
    if (v9 - v10 <= 0)
        v11 = v10 - v9;
    v12 = v1->field_13C;
...
void entity_mode_417670(Entity *a1)
{
    ...
    v1 = a1;
    v22 = 0;
    v2 = &a1->pathing._2C_waypoint_map_x;
    while (1)
    {
        boxd_44D250(v2, &v1->pathing._2C_waypoint_map_y, 1, v1, &v1->pathing.field_3C);
        v3 = *v2;
        v4 = v1->field_CC - *v2;
        if (v4 <= 0)
            v4 = v3 - v1->field_CC;
        v5 = v1->pathing._2C_waypoint_map_y;
        v6 = v1->field_D0 - v5;
        if (v6 <= 0)
            v6 = v5 - v1->field_D0;
        v7 = v4 + v6;
        ...
        boxd_44D250(&v1->pathing._34_waypoint_map_x, &v1->pathing._34_waypoint_map_y, 0, v1, &v1->pathing._40_xy_idx);
        v10 = v1->pathing._34_waypoint_map_x;
        v11 = v1->field_CC - v1->pathing._34_waypoint_map_x;
        if (v11 <= 0)
            v11 = v10 - v1->field_CC;
        v12 = v1->pathing._34_waypoint_map_y;
        v13 = v1->field_D0 - v12;
        if (v13 <= 0)
            v13 = v12 - v1->field_D0;
        v14 = v11 + v13;
        ...
        if (v17 > 1)
        {
            ...
            {
                v20 = v1->field_13C;
                v21 = v1->pathing._2C_waypoint_map_y - v20 <= 0 ? v20 - v1->pathing._2C_waypoint_map_y : v1->pathing._2C_waypoint_map_y - v20;
                if (v21 <= 1)
                    break;
            }
        }
...
void entity_417810(Entity *a1)
{
    ...
    if (v3 != v2->x >> 13 || v1->field_150 != v2->y >> 13)
    {
        ...
        v6 = v1->stats;
        if (v6->is_infantry)
            v7 = map_get_entity_placement_inside_tile_x(v1, v1->_A4_idx_in_tile);
        else
        ...
        v1->sprite_x = v8;
        if (v9->is_infantry)
            v10 = map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile);
        else
            v10 = v9->field_4C != 128 ? 7424 : 4096;
        v1->sprite_y = v10 + (v1->field_D0 << 13);
        v1->pathing._2C_waypoint_map_x = v1->sprite->_60_mobd_anim_speed;
        v13 = v1->field_124;
        v1->_128_spawn_param = 0;
        LOBYTE_HEXRAYS(v13) = v13 & 0xFE;
        v1->SetMode(entity_mode_417BD0);
        v1->field_124 = v13;
...
void entity_417980(Entity *a1)
{
    ...
    v1->_128_spawn_param = 0;
    v1->pathing._2C_waypoint_map_x = v4;
    v5 = v1->field_124;
...
void entity_mode_417BD0(Entity *a1)
{
    ...
    v1 = a1;
    a1->sprite->_60_mobd_anim_speed = a1->pathing._2C_waypoint_map_x;
        ...
        if (v1->stats->is_infantry)
        {
            ...
            LABEL_35:
                if (v18 == 3)
                {
                    ...
                    v1->SetMode(entity_mode_417FC0);
                    v1->mode_return = entity_mode_attack_move_2_5_4165C0;
                    v1->pathing._2C_waypoint_map_x = v1->sprite->x_speed;
                    v1->pathing._2C_waypoint_map_y = v1->sprite->y_speed;
                    v1->sprite->x_speed = 0;
                    v1->sprite->y_speed = 0;
                    v22 = v1->field_124;
...
void entity_417F60(Entity *a1)
{
    ...
    entity_load_idle_mobd(a1);
    v2 = v1->sprite;
    v1->pathing._2C_waypoint_map_x = v2->x_speed;
    v1->pathing._2C_waypoint_map_y = v2->y_speed;
    v2->x_speed = 0;
    v1->sprite->y_speed = 0;
    v3 = v1->field_124;
...
void entity_mode_417FC0(Entity *a1)
{
    ...
    v1 = a1;
    a1->sprite->x_speed = a1->pathing._2C_waypoint_map_x;
    a1->sprite->y_speed = a1->pathing._2C_waypoint_map_y;
...
void entity_mode_4181B0(Entity *a1)
{
    ...
    v1 = a1;
    v2 = boxd_get_tile(a1->pathing._2C_waypoint_map_x, a1->pathing._2C_waypoint_map_y);
...
void entity_418290(Entity *a1)
{
    ...
    if (!v1->IsInfantry())
    {
        auto rot = _42D560_get_mobd_lookup_id_rotation(
        ...
        if (v1->GetCurrentAnimFrame() == rot) {
            ...
            v1->_88_dst_orientation = rot;
            v1->SetTurnReturnMode(entity_mode_418590);
            entity_load_move_mobd(v1);
            v1->sprite->x_speed = 0;
            v1->sprite->y_speed = 0;
            v1->SetMode(entity_mode_rotate_to_target_415A60);
        ...
        int dx = v1->sprite->x - map_adjust_entity_in_tile_x(v1, v1->sprite->x);
        int dy = v1->sprite->y - map_adjust_entity_in_tile_y(v1, v1->sprite->y);
        if (abs(dx) <= 1792 && abs(dy) <= 1792) {
            v1->SetMode(entity_mode_418550);
            v1->pathing._2C_waypoint_map_x = kknd_rand_3() & 0x3F;
        } else {
            v1->SetReturnMode(entity_mode_418590);
...
void entity_mode_418590(Entity *a1)
{
    ...
    v1 = a1;
    v2 = a1->entity_8;
    if (!v2 || !entity_413120_can_fire_on_entity(a1, v2, a1->entity_118_entity_id))
    {
    LABEL_23:
        entity_4133D0(v1);
        return;
...
void entity_mode_418FE0_repairing_in_bay(Entity *a1)
{
    ...
    if (!v3 || (v4 = v3->entity_id) == 0 || v4 != v1->retaliation_target_id)
    {
        v1->hitpoints = 0;
        v1->destroyed = 1;
        v1->SetMode(entity_419560_on_death);
...
void entity_4192F0(Entity *a1)
{
    ...
    v1->SetMode(entity_mode_419390_oiltanker);
    if (v3)
    {
        v4 = v3->_4_entity;
        v5 = v4->stru60.ptr_14;
        ...
        v9 = v7 + v8->y;
        v10 = v1->sprite;
        if (map_is_same_tile(v10->x, v6 + v8->x) && map_is_same_tile(v10->y, v9))
            entity_40DEC0_boxd(v1, v1->sprite_map_x, v1->sprite_map_y, v1->_A4_idx_in_tile);
    }
}
...
void entity_mode_419390_oiltanker(Entity *a1)
{
    ...
    {
        v1->SetMode(entity_mode_4448C0_oiltanker);
    }
    else
    {
        v1->SetMode(entity_mode_4447C0_oiltanker);
    }
}
...
void entity_mode_move_tanker(Entity *a1)
{
    ...
    {
        entity_load_move_mobd(a1);
        v1->SetMode(entity_mode_move_tanker);
    }
    v5 = v1->stats;
    if (v1->IsInfantry())
        v6 = map_get_entity_placement_inside_tile_x(v1, v1->_A4_idx_in_tile);
    else
        v6 = v5->field_4C != 128 ? 7424 : 4096;
    v7 = v6 + (v1->sprite_map_x << 13);
    v8 = v1->stats;
    if (v8->is_infantry)
        v9 = map_get_entity_placement_inside_tile_y(v1, v1->_A4_idx_in_tile);
    else
    ...
    if (!v4->destroyed)
    {
        ...
        case EVT_MSG_1546_repair_at_station:
            ...
            *(_DWORD *)(*((_DWORD *)param + 23) + 136) = 1;
            ...
            Map_40DF50_update_tile(v4, 1);
            v4->SetMode(entity_mode_move_attack);
            break;
