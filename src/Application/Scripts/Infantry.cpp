...
bool entity_413120(Entity *a1, Entity *a2, int entity_id)
{
    ...
    if (!v4->IsMode(entity_mode_417F50) && !v4->IsMode(entity_mode_418590) && !v4->IsMode(entity_mode_default_idle))
    {
        if (v4->turret)
        {
            v30 >>= 1;
...
bool entity_413A90_boxd(Entity *a1)
{
    ...
    while (Map_40EA50_classify_tile_objects(a1a, v2, v3, v5) != 2)
    {
        if (v14 & 1)
        {
            v2 += v4;
...
int entity_413C10(Entity *a1)
{
    ...
    v6 = ((unsigned __int8)v1->GetCurrentFrame() + 16) & 0xE0;
    v7 = v6 >> 5;
    ...
    if (result != 2)
    {
        ...
        v6 = v9 & 0xE0;
    LABEL_7:
        result = Map_40EA50_classify_tile_objects(
            v1,
...
void entity_414440_boxd(Entity *a1, int *a2, int *a3)
{
    ...
    if (entity_is_xl_vehicle(a1))
    {
        ...
        if (!Map_40EA50_classify_tile_objects(a1, v4, v5, v6))
        {
            ...
            v7 = v5 - 1;
            if (!Map_40EA50_classify_tile_objects(v3, v4, v7, &v6[-_4793F8_map_width]))
            {
                if (!Map_40EA50_classify_tile_objects(v3, v4 - 1, v7, &v6[-(_4793F8_map_width + 1)]))
                    return;
                *v8 -= 0x2000;
            }
            *a3 -= 0x2000;
...
bool entity_414AD0_vehicle_collide_vehicle(Entity *a1)
{
    ...
    while (1)
    {
        if (*v9)
        {
            v10 = (*v9)->GetCurrentFrame();
            v11 = v1->GetCurrentFrame();
            v12 = abs(v10 - v11);
            if (v12 > 48)
                break;
        }
...
LABEL_18:
    v5 = v1->stats;
    v6 = v1->GetCurrentFrame();
    v1->SetCurrentFrame(v3);
    if (v5->field_4C == 128)
    {
        v7 = v1->sprite;
        v8 = v3 >> 4;
...
void entity_mode_empty(Entity *a1) {
    ;
}
...
{
    if (a1->GetCurrentFrame() == a1->_88_dst_orientation)
    {
        a1->SetMode(a1->mode_turn_return);
    }
    else
    {
        int frame = a1->GetCurrentFrame();
        entity_advance_mobd_rotation(&frame, a1->_88_dst_orientation, a1->stats->turning_speed);
        a1->SetCurrentFrame(frame);

        sprite_4273B0_load_mobd_item_sound(
            a1->sprite,
            a1->stats->mobd_lookup_offset_move,
            _47D3C4_entity_mobd_lookup_ids[a1->GetCurrentFrame() + 1]);
    }
}
    ...
    if (!entity_initialize_order(a1))
    {
        ...
        switch (a1->pathing._41B970_result)
        {
            case 2:
            {
                ...
                {
                    a1->sprite_x = entity_transform_x(a1, map2global(a1->pathing.destination_map_x));
                    a1->sprite_y = entity_transform_y(a1, map2global(a1->pathing.destination_map_y));
                }
...
void entity_mode_attack_move_1_415D30(Entity *a1)
{
    ...
    else
    {
        ...
        int tile_classf = Map_40EA50_classify_tile_objects(
            a1,
            a1->pathing._2C_waypoint_map_x,
            a1->pathing._2C_waypoint_map_y,
            Map_get_tile(a1->pathing._2C_waypoint_map_x, a1->pathing._2C_waypoint_map_y)
        );
        if (tile_classf == 2
            && boxd_41C130(
                entity_transform_x(v1, map2global(v1->pathing._2C_waypoint_map_x)),
                entity_transform_y(v1, map2global(v1->pathing._2C_waypoint_map_y)),
                v1->sprite->x,
                v1->sprite->y,
                v1
            )
        ...
        {
            v1->sprite_x = entity_transform_x(v1, map2global(v1->pathing._2C_waypoint_map_x));
            v1->sprite_y = entity_transform_y(v1, map2global(v1->pathing._2C_waypoint_map_y));
            entity_mode_attack_move_2_5_4165C0(v1);
        }
        else
        {
...
void entity_mode_move_to_target_416790(Entity *a1)
{
    ...
    if (v1->field_124 & 1
        ...
        || v18 == v1->GetCurrentFrame() //      or we are facing right direction - move
    )
    {
    LABEL_37:
    ...
    sprite_4272E0_load_mobd_item(v28, v1->stats->mobd_lookup_offset_move, _47D3C4_entity_mobd_lookup_ids[v1->GetCurrentFrame() + 1]);
    v1->sprite->x_speed = 0;
    v1->sprite->y_speed = 0;
...
LABEL_24:
        ...
        || ((v21 = v1->sprite_y, v16->y - v21 <= 0) ? (v22 = v21 - v16->y) : (v22 = v16->y - v21), v22 >= 512))
    {
        ...
        v24 = v1->stats;
        if (v24->is_infantry || v1->GetCurrentFrame() == v23)
        {
...
void entity_mode_416CD0(Entity *a1)
{
    ...
    {
        v9 = v1->sprite;
        v1->SetCurrentFrame(_42D560_get_mobd_lookup_id_rotation(v3 - v4, v1->sprite_y - v2->y));
        sprite_4273B0_load_mobd_item_sound(
            v9,
...
LABEL_24:
        ...
        || ((v21 = v1->sprite_y, v16->y - v21 <= 0) ? (v22 = v21 - v16->y) : (v22 = v16->y - v21), v22 >= 1792))
    {
        v23 = _42D560_get_mobd_lookup_id_rotation(v19 - v18, v1->sprite_y - v16->y);
        v24 = v1->stats;
        if (v24->is_infantry || (v25 = v1->GetCurrentFrame(), v25 == v23))
        {
            entity_load_move_mobd(v1, v23);
            v1->SetMode(entity_mode_417100);
        }
        else
        {
            v1->_88_dst_orientation = v23;
...
void entity_417810(Entity *a1)
{
    ...
    if (v3 != v2->x >> 13 || v1->field_150 != v2->y >> 13)
    {
        ...
        if (v1->field_D4)
        {
            v1->field_D8 = ((unsigned __int8)v1->GetCurrentFrame() + 64) & 0xE0;
        }
        else
        {
            v1->field_D8 = ((unsigned __int8)v1->GetCurrentFrame() - 64) & 0xE0;
...
void entity_mode_417FC0(Entity *a1)
{
    ...
    if (v6)
    {
        ...
        if (v7)
        {
            ...
            {
                v8 = v1->GetCurrentFrame();
                if (v6->GetCurrentFrame() - v8 <= 0)
                    v9 = v8 - v6->GetCurrentFrame();
                else
                    v9 = v6->GetCurrentFrame() - v8;
                if (v9 <= 48)
                {
...
void entity_mode_4181B0(Entity *a1)
{
    ...
    v1 = a1;
    v2 = Map_get_tile(a1->pathing._2C_waypoint_map_x, a1->pathing._2C_waypoint_map_y);
...
void entity_418290(Entity *a1)
{
    ...
    if (!v1->stats->is_infantry)
    {
        if (v1->GetCurrentFrame() != (signed __int16)_42D560_get_mobd_lookup_id_rotation(
    ...
    if (v12 <= 1792)
    {
        ...
        LABEL_29:
            ...
            int rnd = kknd_rand_3();
            v1->pathing._2C_waypoint_map_x = rnd & 0x3F;
            return;
        }
    }
...
void entity_mode_418590(Entity *a1)
{
    ...
    if (v6 && _47C048_unit_bomberdmg < 200)
    {
        ...
        v9 = v7;
        if (v8 != -1)
            sprite_4272E0_load_mobd_item(v7, v8, _47D3C4_entity_mobd_lookup_ids[v1->GetCurrentFrame() + 1]);
        v10 = v9->script;
...
void entity_mode_419230(Entity *a1)
{
    ...
    int frame = a1->GetCurrentFrame();
    int adv = entity_advance_mobd_rotation(&frame, 160, v1->stats->turning_speed);
    a1->SetCurrentFrame(frame);
...
void entity_mode_move_tanker(Entity *a1)
{
    ...
    v19 = _47D3C4_entity_mobd_lookup_ids[a1->GetCurrentFrame() + 1];
    v4 = a1->sprite;
...
void entity_mode_4197E0_infantry(Entity *a1)
{
    a1->sprite->x_speed = 0;
    a1->sprite->y_speed = 0;
    entity_load_move_mobd(a1, a1->GetCurrentFrame() + 64);
