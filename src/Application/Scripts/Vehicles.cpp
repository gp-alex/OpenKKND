...
void entity_mode_444630_oiltanker(Entity *a1)
{
    ...
    if (!entity_advance_mobd_rotation(&frame, 160, a1->stats->turning_speed))
...
void entity_mode_4446B0_oiltanker_load_oil(Entity *a1)
{
    ...
    if (v2->_0_oil_loaded < 500)
    {
        ...
        v1->SetMode(entity_mode_4446A0_oiltanker);
        goto LABEL_22;
    }
...
void entity_mode_4447C0_oiltanker(Entity *a1)
{
    ...
    {
        v1->SetMode(entity_mode_444590_oiltanker);
    }
}
...
void entity_mode_4448C0_oiltanker(Entity *a1)
{
    ...
    {
        v1->SetMode(entity_mode_4444F0_oiltanker);
    }
}
...
{
    a1->sprite->x_speed = -(a1->stats->speed * _4731A8_speeds[__47CFC4_mobd_lookup_speeds[a1->GetCurrentFrame() + 1]] >> 6);
    a1->sprite->y_speed = -(-entity_get_mobd_speed_y(a1));
    a1->SetMode(entity_mode_444B40_oiltanker_unload_oil);
    script_sleep(a1->script, 80);
}
...
void entity_mode_444B40_oiltanker_unload_oil(Entity *a1)
{
    ...
    {
        v1->SetMode(entity_mode_444AB0_oiltanker);
    }
}
    ...
    if (!v5->destroyed)
    {
        ...
        case EVT_MSG_1542_tanker_set_drillrig:
            ...
            if (*(_DWORD *)(v17 + 12) == *(_DWORD *)(v17 + 4))
                v5->SetMode(entity_mode_4448C0_oiltanker);
        ...
        case EVT_MSG_1541_tanker_set_base:
            ...
            if (*(_DWORD *)(v20 + 8) == *(_DWORD *)(v20 + 4))
                v5->SetMode(entity_mode_4447C0_oiltanker);
        ...
        case EVT_MSG_1540:
            if (*((Entity **)v6 + 1) == v4)
            {
                if (v5->IsMode(entity_mode_4446B0_oiltanker_load_oil))
                {
                    v21 = v5->script;
                    goto LABEL_65;
                }
        ...
        case EVT_MSG_1539:
            if (*((Entity **)v6 + 1) == v4)
            {
                if (v5->IsMode(entity_mode_444B40_oiltanker_unload_oil))
                {
                    v21 = v5->script;
                LABEL_65:
                    script_sleep(v21, 1);
                    v5->hitpoints = 0;
                    v5->SetMode(entity_419560_on_death);
                    v5->destroyed = 1;
                }
                else
                {
...
void entity_mode_406DC0_mobilederrick(Entity *a1)
{
    ...
    if (v2)
    {
        ...
        if (!entity_advance_mobd_rotation(&frame, 160, v1->stats->turning_speed))
